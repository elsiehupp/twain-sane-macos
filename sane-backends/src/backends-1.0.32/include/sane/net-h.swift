...
public void sanei_w_init_req (Wire *w, SANE_Init_Req *req);
public void sanei_w_init_reply (Wire *w, SANE_Init_Reply *reply);
public void sanei_w_get_devices_reply (Wire *w, SANE_Get_Devices_Reply *reply);
public void sanei_w_open_reply (Wire *w, SANE_Open_Reply *reply);
public void sanei_w_option_descriptor_array (Wire *w,
					   SANE_Option_Descriptor_Array *opt);
public void sanei_w_control_option_req (Wire *w, SANE_Control_Option_Req *req);
...
public void sanei_w_start_reply (Wire *w, SANE_Start_Reply *reply);
public void sanei_w_authorization_req (Wire *w, SANE_Authorization_Req *req);
