 ...
 *
 */
public SANE_Status sanei_pa4s2_open (const char *dev, Int *fd);
 ...
 *
 */
public SANE_Status sanei_pa4s2_scsi_pp_open (const char *dev, Int *fd);
 ...
 * - SANE_STATUS_GOOD - on success
 */
public SANE_Status sanei_pa4s2_options (u_int * options, Int set);
 ...
 */
public SANE_Status sanei_pa4s2_enable (Int fd, Int enable);
 ...
 */
public SANE_Status sanei_pa4s2_readbegin (Int fd, u_char reg);
 ...
 * - SANE_STATUS_INVAL - if fd is invalid or device not in use
 */
public SANE_Status sanei_pa4s2_scsi_pp_get_status (Int fd, u_char *status);
 ...
 */
public SANE_Status sanei_pa4s2_scsi_pp_reg_select (Int fd, Int reg);
 ...
 */
public SANE_Status sanei_pa4s2_readbyte (Int fd, u_char * val);
 ...
 */
public SANE_Status sanei_pa4s2_readend (Int fd);
 ...
 * - SANE_STATUS_INVAL - if fd is invalid or device not in use
 */
public SANE_Status sanei_pa4s2_writebyte (Int fd, u_char reg, u_char val);
