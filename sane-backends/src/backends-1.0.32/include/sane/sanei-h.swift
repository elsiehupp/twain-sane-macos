...
/** @fn public SANE_Status sanei_check_value (const SANE_Option_Descriptor * opt, void * value);
...
/** @fn public SANE_Status sanei_constrain_value (const SANE_Option_Descriptor * opt, void * value, SANE_Word * info);
...
public SANE_Status sanei_check_value (const SANE_Option_Descriptor * opt,
				      void * value);

public SANE_Status sanei_constrain_value (const SANE_Option_Descriptor * opt,
