...
public SANE_Status sanei_pv8630_write_byte (Int fd, SANEI_PV_Index index,
					    SANE_Byte byte);
public SANE_Status sanei_pv8630_read_byte (Int fd, SANEI_PV_Index index,
					   SANE_Byte * byte);
public SANE_Status sanei_pv8630_prep_bulkread (Int fd, Int len);
public SANE_Status sanei_pv8630_prep_bulkwrite (Int fd, Int len);
public SANE_Status sanei_pv8630_flush_buffer (Int fd);
public SANE_Status sanei_pv8630_bulkwrite (Int fd, const void *data,
					   size_t * len);
public SANE_Status sanei_pv8630_bulkread (Int fd, void *data, size_t * len);
public SANE_Status sanei_pv8630_xpect_byte (Int fd, SANEI_PV_Index index,
					    SANE_Byte value, SANE_Byte mask);
public SANE_Status sanei_pv8630_wait_byte (Int fd, SANEI_PV_Index index,
					   SANE_Byte value, SANE_Byte mask,
					   Int timeout);
