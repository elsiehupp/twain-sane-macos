 ...
 */
public SANE_Status sanei_usb_testing_enable_replay(SANE_String_Const path,
 ...
 */
public SANE_Status sanei_usb_testing_enable_record(SANE_String_Const path,
 ...
 */
public SANE_String sanei_usb_testing_get_backend();

/** Returns SANE_TRUE if replay testing mode is enabled, i.e. whether we are working with fake
 * scan data.
 */
public SANE_Bool sanei_usb_is_replay_mode_enabled();
 ...
 */
public SANE_Status sanei_usb_open (SANE_String_Const devname, SANE_Int * dn);
 ...
 *
 */
public void sanei_usb_set_endpoint (SANE_Int dn, SANE_Int ep_type, SANE_Int ep);
 ...
 *
 */
public SANE_Int sanei_usb_get_endpoint (SANE_Int dn, SANE_Int ep_type);

/** Close a USB device.
 *
 * @param dn device number
 */
public void sanei_usb_close (SANE_Int dn);

/** Set the libusb timeout for bulk and interrupt reads.
 *
 * @param timeout the new timeout in ms
 */
public void sanei_usb_set_timeout (SANE_Int timeout);
 ...
 * @param dn device number
 */
public SANE_Status sanei_usb_clear_halt (SANE_Int dn);
 ...
 * @param dn device number
 */
public SANE_Status sanei_usb_reset (SANE_Int dn);
