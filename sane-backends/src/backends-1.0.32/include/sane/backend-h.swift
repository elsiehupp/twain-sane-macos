...
public SANE_Status ENTRY(init) (SANE_Int *, SANE_Auth_Callback);
public SANE_Status ENTRY(get_devices) (const SANE_Device ***, SANE_Bool);
public SANE_Status ENTRY(open) (SANE_String_Const, SANE_Handle *);
public const SANE_Option_Descriptor *
  ENTRY(get_option_descriptor) (SANE_Handle, SANE_Int);
public SANE_Status ENTRY(control_option) (SANE_Handle, SANE_Int, SANE_Action,
                                          void *, SANE_Word *);
public SANE_Status ENTRY(get_parameters) (SANE_Handle, SANE_Parameters *);
public SANE_Status ENTRY(start) (SANE_Handle);
public SANE_Status ENTRY(read) (SANE_Handle, SANE_Byte *, SANE_Int,
                                SANE_Int *);
public SANE_Status ENTRY(set_io_mode) (SANE_Handle, SANE_Bool);
public SANE_Status ENTRY(get_select_fd) (SANE_Handle, SANE_Int *);
public void ENTRY(cancel) (SANE_Handle);
public void ENTRY(close) (SANE_Handle);
