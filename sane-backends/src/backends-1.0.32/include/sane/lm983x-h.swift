 ...
 * - SANE_STATUS_INVAL    - register out of range
 */
public SANE_Status sanei_lm983x_write_byte( SANE_Int fd,
 ...
 */
public SANE_Status sanei_lm983x_write( SANE_Int fd, SANE_Byte reg,
 ...
 */
public SANE_Status sanei_lm983x_read( SANE_Int fd, SANE_Byte reg,
                                      SANE_Byte *buffer, SANE_Word len,
                                                         SANE_Bool increment );
 ...
 */
public SANE_Bool sanei_lm983x_reset( SANE_Int fd );
