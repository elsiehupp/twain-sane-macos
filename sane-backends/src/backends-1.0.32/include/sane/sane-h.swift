...
public SANE_Status sane_init (SANE_Int * version_code,
			      SANE_Auth_Callback authorize);
public void sane_exit (void);
public SANE_Status sane_get_devices (const SANE_Device *** device_list,
				     SANE_Bool local_only);
public SANE_Status sane_open (SANE_String_Const devicename,
			      SANE_Handle * handle);
public void sane_close (SANE_Handle handle);
public const SANE_Option_Descriptor *
  sane_get_option_descriptor (SANE_Handle handle, SANE_Int option);
public SANE_Status sane_control_option (SANE_Handle handle, SANE_Int option,
					SANE_Action action, void *value,
					SANE_Int * info);
public SANE_Status sane_get_parameters (SANE_Handle handle,
					SANE_Parameters * params);
public SANE_Status sane_start (SANE_Handle handle);
public SANE_Status sane_read (SANE_Handle handle, SANE_Byte * data,
			      SANE_Int max_length, SANE_Int * length);
public void sane_cancel (SANE_Handle handle);
public SANE_Status sane_set_io_mode (SANE_Handle handle,
				     SANE_Bool non_blocking);
public SANE_Status sane_get_select_fd (SANE_Handle handle,
				       SANE_Int * fd);
public SANE_String_Const sane_strstatus (SANE_Status status);
