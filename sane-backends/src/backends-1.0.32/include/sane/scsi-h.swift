 ...
 */
public SANE_Status sanei_scsi_open (const char * device_name, Int * fd,
 ...
 */
public SANE_Status sanei_scsi_open_extended (
 ...
 *
*/
public SANE_Status sanei_scsi_req_enter (Int fd,
 ...
 */
public SANE_Status sanei_scsi_req_enter2 (Int fd,
 ...
 * - SANE_STATUS_IO_ERROR - if an error was received from the SCSI driver
*/
public SANE_Status sanei_scsi_req_wait (void *id);
 ...
 */
public SANE_Status sanei_scsi_cmd (Int fd,
				   const void * src, size_t src_size,
				   void * dst, size_t * dst_size);
 ...
 */
public SANE_Status sanei_scsi_cmd2 (Int fd,
				   const void * cmd, size_t cmd_size,
				   const void * src, size_t src_size,
				   void * dst, size_t * dst_size);
