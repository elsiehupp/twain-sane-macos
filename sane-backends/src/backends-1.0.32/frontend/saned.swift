...
#ifdef _AIX
# include "../include/lalloca		/* MUST come first for AIX! */
#endif
...
import ../include/sane/sanei_codec_bin
import ../include/sane/sanei_config

import ../include/sane/sanei_auth
...
static Int
store_reclen (SANE_Byte * buf, size_t buf_size, var i: Int, size_t reclen)
{
