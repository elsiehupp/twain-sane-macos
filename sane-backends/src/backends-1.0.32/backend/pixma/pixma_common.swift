...
#include <stdarg
#include <ctype
#include <math		/* pow(C90) */

#include <sys/time		/* gettimeofday(4.3BSD) */
...
public const pixma_config_t pixma_mp150_devices[]
public const pixma_config_t pixma_mp750_devices[]
public const pixma_config_t pixma_mp730_devices[]
public const pixma_config_t pixma_mp800_devices[]
public const pixma_config_t pixma_iclass_devices[]
...
func Int pixma_find_scanners (const char **conf_devices, SANE_Bool local_only)
{
