 ...
 */
public SANE_Status sanei_bjnp_open (SANE_String_Const devname, SANE_Int * dn)
...
public void sanei_bjnp_close (SANE_Int dn)
...
public SANE_Status sanei_bjnp_activate (SANE_Int dn)
...
public SANE_Status sanei_bjnp_deactivate (SANE_Int dn)
 ...
 */
public void sanei_bjnp_set_timeout (SANE_Int devno, SANE_Int timeout)
