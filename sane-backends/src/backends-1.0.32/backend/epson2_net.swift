...
public ssize_t sanei_epson_net_read(struct Epson_Scanner *s, unsigned char *buf, ssize_t buf_size,
				SANE_Status *status);
public size_t sanei_epson_net_write(struct Epson_Scanner *s, unsigned Int cmd, const unsigned char *buf,
				size_t buf_size, size_t reply_len,
				SANE_Status *status);
public SANE_Status sanei_epson_net_lock(struct Epson_Scanner *s);
public SANE_Status sanei_epson_net_unlock(struct Epson_Scanner *s);
