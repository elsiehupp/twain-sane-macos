...
HP5400_SANE_STATIC
func Int InitScan2 (enum ScanType type, struct ScanRequest *req,
...
HP5400_SANE_STATIC
func Int SetCopyCount(THWParams * pHWParams, SANE_Word copyCount);

HP5400_SANE_STATIC
func Int SetColourBW(THWParams * pHWParams, SANE_Word colourBW);
...
HP5400_SANE_STATIC
func Int InitHp5400_internal( void );

HP5400_SANE_STATIC
func Int FreeHp5400_internal( void );
...
import hp5400
import hp5400_xfer
import hp5400_internal
import hp5400_debug /* debug functions */
...
HP5400_SANE_STATIC
func Int InitScan2 (enum ScanType scantype, struct ScanRequest *req,
