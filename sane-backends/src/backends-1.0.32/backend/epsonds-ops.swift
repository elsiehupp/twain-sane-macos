...
public SANE_Status eds_dev_post_init(struct epsonds_device *dev)

public SANE_Bool eds_is_model(epsonds_device *dev, const char *model)

public SANE_Status eds_add_resolution(epsonds_device *dev, Int r)
public SANE_Status eds_set_resolution_range(epsonds_device *dev, Int min, Int max)
...
public SANE_Status eds_add_depth(epsonds_device *dev, SANE_Word depth)
public SANE_Status eds_discover_capabilities(epsonds_scanner *s)
public SANE_Status eds_set_extended_scanning_parameters(epsonds_scanner *s)
public SANE_Status eds_set_scanning_parameters(epsonds_scanner *s)
public void eds_setup_block_mode(epsonds_scanner *s)
public SANE_Status eds_init_parameters(epsonds_scanner *s)

public void eds_copy_image_from_ring(epsonds_scanner *s, SANE_Byte *data, SANE_Int max_length,
                   SANE_Int *length)

public SANE_Status eds_ring_init(ring_buffer *ring, SANE_Int size)
public SANE_Status eds_ring_write(ring_buffer *ring, SANE_Byte *buf, SANE_Int size)
public SANE_Int eds_ring_read(ring_buffer *ring, SANE_Byte *buf, SANE_Int size)
public SANE_Int eds_ring_skip(ring_buffer *ring, SANE_Int size)
public SANE_Int eds_ring_avail(ring_buffer *ring)
