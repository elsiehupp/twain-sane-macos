...
public size_t epsonds_net_write(struct epsonds_scanner *s, unsigned Int cmd, const unsigned char *buf,
				...
				SANE_Status *status)
public SANE_Status epsonds_net_lock(struct epsonds_scanner *s)
public SANE_Status epsonds_net_unlock(struct epsonds_scanner *s)
public SANE_Status epsonds_net_request_read(epsonds_scanner *s, size_t len)
