...
#define PRELOAD_DECL(name)                                                            \
  public SANE_Status BE_ENTRY(name,init) (SANE_Int *, SANE_Auth_Callback);                  \
  public void BE_ENTRY(name,exit) (void);                  \
  public SANE_Status BE_ENTRY(name,get_devices) (const SANE_Device ***, SANE_Bool);           \
  public SANE_Status BE_ENTRY(name,open) (SANE_String_Const, SANE_Handle *);                  \
  public void BE_ENTRY(name,close) (SANE_Handle);                 \
  public const SANE_Option_Descriptor *BE_ENTRY(name,get_option_descriptor) (SANE_Handle,  SANE_Int); \
  public SANE_Status BE_ENTRY(name,control_option) (SANE_Handle, SANE_Int, SANE_Action, void *, SANE_Int *);        \
  public SANE_Status BE_ENTRY(name,get_parameters) (SANE_Handle, SANE_Parameters *);        \
  public SANE_Status BE_ENTRY(name,start) (SANE_Handle);                 \
  public SANE_Status BE_ENTRY(name,read) (SANE_Handle, SANE_Byte *, SANE_Int, SANE_Int *);                  \
  public void BE_ENTRY(name,cancel) (SANE_Handle);                \
  public SANE_Status BE_ENTRY(name,set_io_mode) (SANE_Handle, SANE_Bool);           \
  public SANE_Status BE_ENTRY(name,get_select_fd) (SANE_Handle, SANE_Int *);
