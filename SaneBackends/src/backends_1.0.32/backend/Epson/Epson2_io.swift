...
public unsigned Int r_cmd_count
public unsigned Int w_cmd_count


Sane.Status e2_cmd_simple(Epson_Scanner * s, void *buf, size_t buf_size)
Int e2_send(Epson_Scanner * s, void *buf, size_t buf_size,
		size_t reply_len, Sane.Status * status)
...
Sane.Status
e2_cmd_info_block(Sane.Handle handle, unsigned char *params,
		      unsigned char params_len, size_t reply_len,
		      unsigned char **buf, size_t * buf_len)

Sane.Status e2_ack(Epson_Scanner * s)
Sane.Status e2_ack_next(Epson_Scanner * s, size_t reply_len)
Sane.Status e2_cancel(Epson_Scanner * s)
...
func Int e2_send(Epson_Scanner * s, void *buf, size_t buf_size, size_t reply_len,
	    Sane.Status * status)
{
 ...
 * even if the status != Sane.STATUS_GOOD.
 */
