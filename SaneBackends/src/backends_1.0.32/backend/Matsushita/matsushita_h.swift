...
#define GRAY4_STR			Sane.I18N("Grayscale 4 bits")
#define GRAY8_STR			Sane.I18N("Grayscale 8 bits")
...
struct scanners_supported
{
  ...
  Sane.String_Const *scan_mode_list;	/* array of scan modes */
  const Sane.Word *resolutions_list;	/* array of available resolutions */
  const Sane.Word *resolutions_round;	/* rounding values for each resolutions */

  Sane.String_Const *image_emphasis_list;	/* list of image emphasis options */
...
struct paper_sizes
{
  Sane.String_Const name;	/* name of the paper */
  Int width
  Int length
]
...
typedef struct Matsushita_Scanner
{
  ...
  Sane.String_Const *paper_sizes_list;	/* names of supported papers */
  ...
  Sane.Byte *image;		/* keep the current image there */
