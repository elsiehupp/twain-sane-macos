...
static Rts8891_Model hp4400c_model = {
  ...
  Sane.FIX(8.3),		/* Start of scan area in mm  (x) */
  Sane.FIX(3.0),		/* Start of scan area in mm(y) */
  Sane.FIX(215.9),		/* Size of scan area in mm(x) */
  Sane.FIX(298.1),		/* Size of scan area in mm(y) */
