...
{
  Int fb = !strcmp(s.val[SOURCE].s, Sane.I18N("fb"))
...
static const Sane.Range resolutions_range = {
  100,600,1
]
...
static Sane.String_Const paper_list_woA3[] = {
  Sane.I18N("user_def"),
  Sane.I18N("business_card"),
  Sane.I18N("Check"),
  /*Sane.I18N("A3"), */
...
static Sane.Range tl_x_range_A4 = { 0, MAX_WIDTH_A4 - MIN_WIDTH, 0 ]
static Sane.Range tl_y_range_A4 = { 0, MAX_LENGTH_A4 - MIN_LENGTH, 0 ]
static Sane.Range br_x_range_A4 = { MIN_WIDTH, MAX_WIDTH_A4, 0 ]
static Sane.Range br_y_range_A4 = { MIN_LENGTH, MAX_LENGTH_A4, 0 ]

static Sane.Range byte_value_range = { 0, 255, 0 ]
static Sane.Range compression_value_range = { 1, 0x64, 0 ]
...
static Sane.String_Const dfeed_sence_list[] = {
  Sane.I18N("Normal"),
  Sane.I18N("High sensitivity"),
  Sane.I18N("Low sensitivity"),
  NULL
]

/* Lists of supported halftone. They are only valid with
 * for the Black&White mode. */
static Sane.String_Const halftone_pattern[] = {
  Sane.I18N("bayer_64"),
  Sane.I18N("bayer_16"),
  Sane.I18N("halftone_32"),
  Sane.I18N("halftone_64"),
  Sane.I18N("err_diffusion"),
  NULL
]

/*  Stapled document */
static Sane.String_Const stapeled_list[] = {
  Sane.I18N("No detection"),
  Sane.I18N("Normal mode"),
  Sane.I18N("Enhanced mode"),
  NULL
]
...
kvs40xx_init_options(struct scanner *s)
{
  ...
  /* Scan source */
  o = &s.opt[SOURCE]
  o.name = Sane.NAME_SCAN_SOURCE
  o.title = Sane.TITLE_SCAN_SOURCE
  o.desc = Sane.DESC_SCAN_SOURCE
  o.type = Sane.TYPE_STRING
  ...
  o = &s.opt[LONG_PAPER]
  o.name = "long-paper"
  o.title = Sane.I18N("Long paper mode")
  o.desc = Sane.I18N("Long Paper Mode is a mode that the scanner "
		       "reads the image after it divides long paper "
		       "by the length which is set in Document Size option.")
  o.type = Sane.TYPE_BOOL
  o.unit = Sane.UNIT_NONE
  s.val[LONG_PAPER].w = Sane.FALSE
  o.cap |= Sane.CAP_INACTIVE
  ...
  o = &s.opt[DFEED_SENCE]
  o.name = "dfeed-sense"
  o.title = Sane.I18N("Double feed detector sensitivity")
  o.desc = Sane.I18N("Set the double feed detector sensitivity")
  o.type = Sane.TYPE_STRING
  ...
  o = &s.opt[DFSTOP]
  o.name = "dfstop"
  o.title = Sane.I18N("Do not stop after double feed detection")
  o.desc = Sane.I18N("Do not stop after double feed detection")
  o.type = Sane.TYPE_BOOL
  o.unit = Sane.UNIT_NONE
  s.val[DFSTOP].w = Sane.FALSE
  o.cap |= Sane.CAP_INACTIVE

  o = &s.opt[DFEED_L]
  o.name = "dfeed_l"
  o.title = Sane.I18N("Ignore left double feed sensor")
  o.desc = Sane.I18N("Ignore left double feed sensor")
  o.type = Sane.TYPE_BOOL
  o.unit = Sane.UNIT_NONE
  s.val[DFEED_L].w = Sane.FALSE
  o.cap |= Sane.CAP_INACTIVE

  o = &s.opt[DFEED_C]
  o.name = "dfeed_c"
  o.title = Sane.I18N("Ignore center double feed sensor")
  o.desc = Sane.I18N("Ignore center double feed sensor")
  o.type = Sane.TYPE_BOOL
  o.unit = Sane.UNIT_NONE
  s.val[DFEED_C].w = Sane.FALSE
  o.cap |= Sane.CAP_INACTIVE

  o = &s.opt[DFEED_R]
  o.name = "dfeed_r"
  o.title = Sane.I18N("Ignore right double feed sensor")
  o.desc = Sane.I18N("Ignore right double feed sensor")
  o.type = Sane.TYPE_BOOL
  o.unit = Sane.UNIT_NONE
  s.val[DFEED_R].w = Sane.FALSE
  o.cap |= Sane.CAP_INACTIVE
  ...
  o.name = "athreshold"
  o.title = Sane.I18N("Automatic threshold mode")
  o.desc = Sane.I18N("Sets the automatic threshold mode")
  o.type = Sane.TYPE_STRING
  ...
  o = &s.opt[INVERSE]
  o.name = "inverse"
  o.title = Sane.I18N("Inverse Image")
  o.desc = Sane.I18N("Inverse image in B/W mode")
  o.type = Sane.TYPE_BOOL
  o.unit = Sane.UNIT_NONE
  o.cap |= Sane.CAP_INACTIVE
  ...
  o.name = Sane.NAME_HALFTONE_PATTERN
  o.title = Sane.TITLE_HALFTONE_PATTERN
  o.desc = Sane.DESC_HALFTONE_PATTERN
  o.type = Sane.TYPE_STRING
  ...
  o = &s.opt[COMPRESSION]
  o.name = "jpeg"
  o.title = Sane.I18N("JPEG compression")
  o.desc =
    Sane.I18N
  ...
  o.name = "stapeled_doc"
  o.title = Sane.I18N("Detect stapled document")
  o.desc = Sane.I18N("Detect stapled document")
  o.type = Sane.TYPE_STRING
  ...
  /* White level base */
  o = &s.opt[WHITE_LEVEL]
  o.name = Sane.NAME_WHITE_LEVEL
  o.title = Sane.TITLE_WHITE_LEVEL
  o.desc = Sane.DESC_WHITE_LEVEL
  o.type = Sane.TYPE_STRING
  ...
  o.title = Sane.I18N("Noise reduction")
  o.desc = Sane.I18N("Reduce the isolated dot noise")
  o.type = Sane.TYPE_STRING
  ...
  o = &s.opt[RED_CHROMA]
  o.name = "red-chroma"
  o.title = Sane.I18N("chroma of red")
  o.desc = Sane.I18N("Set chroma of red")
  o.type = Sane.TYPE_INT
  o.unit = Sane.UNIT_NONE
  o.size = sizeof(Int)
  o.constraint_type = Sane.CONSTRAINT_RANGE
  ...
  o = &s.opt[BLUE_CHROMA]
  o.name = "blue chroma"
  o.title = Sane.I18N("chroma of blue")
  o.desc = Sane.I18N("Set chroma of blue")
  o.type = Sane.TYPE_INT
  o.unit = Sane.UNIT_NONE
  o.size = sizeof(Int)
  o.constraint_type = Sane.CONSTRAINT_RANGE
  ...
  o = &s.opt[DESKEW]
  o.name = "deskew"
  o.title = Sane.I18N("Skew adjustment")
  o.desc = Sane.I18N("Skew adjustment")
  o.type = Sane.TYPE_BOOL
  o.unit = Sane.UNIT_NONE
  s.val[DESKEW].w = Sane.FALSE
  if(s.id != KV_S4085CL && s.id != KV_S4085CW)
    o.cap |= Sane.CAP_INACTIVE

  o = &s.opt[STOP_SKEW]
  o.name = "stop-skew"
  o.title = Sane.I18N("Stop scanner if a sheet is skewed")
  o.desc = Sane.I18N("Scanner will stop if a sheet is skewed")
  o.type = Sane.TYPE_BOOL
  o.unit = Sane.UNIT_NONE
  s.val[STOP_SKEW].w = Sane.FALSE

  o = &s.opt[CROP]
  o.name = "crop"
  o.title = Sane.I18N("Crop actual image area")
  o.desc = Sane.I18N("Scanner will automatically detect image area and crop to it")
  o.type = Sane.TYPE_BOOL
  o.unit = Sane.UNIT_NONE
  s.val[CROP].w = Sane.FALSE
  if(s.id != KV_S4085CL && s.id != KV_S4085CW)
    o.cap |= Sane.CAP_INACTIVE

  o = &s.opt[MIRROR]
  o.name = "mirror"
  o.title = Sane.I18N("Mirror image")
  o.desc = Sane.I18N("Left/right mirror image")
  o.type = Sane.TYPE_BOOL
  o.unit = Sane.UNIT_NONE
  s.val[MIRROR].w = Sane.FALSE

  o = &s.opt[TOPPOS]
  o.name = "toppos"
  o.title = Sane.I18N("Addition of space in top position")
  o.desc = Sane.I18N("Addition of space in top position")
  o.type = Sane.TYPE_BOOL
  o.unit = Sane.UNIT_NONE
  s.val[TOPPOS].w = Sane.FALSE

  o = &s.opt[BTMPOS]
  o.name = "btmpos"
  o.title = Sane.I18N("Addition of space in bottom position")
  o.desc = Sane.I18N("Addition of space in bottom position")
  o.type = Sane.TYPE_BOOL
  o.unit = Sane.UNIT_NONE
  s.val[BTMPOS].w = Sane.FALSE
}
		     ...
		     Sane.Action action, void *val, Int * info)
{
  ...
  if(action == Sane.ACTION_GET_VALUE)
	...
	{
	  DBG(DBG_INFO,
	       "Sane.control_option: reading opt[%d] =  %s\n",
      ...
      else
	{
	  *(Sane.Word *) val = s.val[option].w
	  DBG(DBG_INFO,
	       "Sane.control_option: reading opt[%d] =  %d\n",
      ...
      if(s.opt[option].type == Sane.TYPE_STRING)
	{
	  if(!strcmp(val, s.val[option].s))
	    return Sane.STATUS_GOOD
	  DBG(DBG_INFO,
	       "Sane.control_option: writing opt[%d] =  %s\n",
      ...
      else
	{
	  if(*(Sane.Word *) val == s.val[option].w)
	    return Sane.STATUS_GOOD
	  DBG(DBG_INFO,
	       "Sane.control_option: writing opt[%d] =  %d\n",
	...
	case TL_Y:
	  if((*(Sane.Word *) val) + MIN_LENGTH <=
	      s.val[BR_Y].w &&
	      !check_area(s, s.val[TL_X].w, *(Sane.Word *) val,
	    ...
	    *info |= Sane.INFO_INEXACT |
	      Sane.INFO_RELOAD_OPTIONS | Sane.INFO_RELOAD_PARAMS
	  return Sane.STATUS_GOOD
	case BR_Y:
	  if((*(Sane.Word *) val) >=
	      s.val[TL_Y].w + MIN_LENGTH
	      && !check_area(s, s.val[TL_X].w, s.val[TL_Y].w,
			      s.val[BR_X].w, *(Sane.Word *) val))
	    {
	      s.val[option].w = *(Sane.Word *) val
	      if(info)
		*info |= Sane.INFO_RELOAD_PARAMS
	...
	case TL_X:
	  if((*(Sane.Word *) val) + MIN_WIDTH <=
	      s.val[BR_X].w &&
	      !check_area(s, *(Sane.Word *) val, s.val[TL_Y].w,
			   s.val[BR_X].w, s.val[BR_Y].w))
	    {
	      s.val[option].w = *(Sane.Word *) val
	      if(info)
	...
	case SOURCE:
	  strcpy(s.val[option].s, val)
	  if(strcmp(s.val[option].s, Sane.I18N("adf")))
	    {
	      strcpy(s.val[FEEDER_MODE].s, feeder_mode_list[0])
	      strcpy(s.val[MANUALFEED].s, manual_feed_list[0])
	      s.val[DUPLEX].w = Sane.FALSE
	      ...
	      s.val[LENGTHCTL].w = Sane.FALSE
	      s.val[LONG_PAPER].w = Sane.FALSE
	      s.opt[FEEDER_MODE].cap |= Sane.CAP_INACTIVE
	      s.opt[MANUALFEED].cap |= Sane.CAP_INACTIVE
	      s.opt[DUPLEX].cap |= Sane.CAP_INACTIVE
	      s.opt[DBLFEED].cap |= Sane.CAP_INACTIVE
	      s.opt[BTMPOS].cap |= Sane.CAP_INACTIVE
	      s.opt[TOPPOS].cap |= Sane.CAP_INACTIVE
	      s.opt[STOP_SKEW].cap |= Sane.CAP_INACTIVE
	      s.opt[LENGTHCTL].cap |= Sane.CAP_INACTIVE
	      s.opt[LONG_PAPER].cap |= Sane.CAP_INACTIVE
	    }
	  else
	    {
	      s.opt[FEEDER_MODE].cap &= ~Sane.CAP_INACTIVE
	...
	case FEEDER_MODE:
	  strcpy(s.val[option].s, val)
	  if(strcmp(s.val[option].s, Sane.I18N("continuous")))
	    {
	      s.opt[LONG_PAPER].cap |= Sane.CAP_INACTIVE
	    }
	  else
	...
	case MODE:
	  strcpy(s.val[option].s, val)
	  if(!strcmp(s.val[option].s, Sane.VALUE_SCAN_MODE_LINEART))
	    {
	      s.opt[GAMMA_CORRECTION].cap |= Sane.CAP_INACTIVE
	      s.opt[COMPRESSION].cap |= Sane.CAP_INACTIVE
	      s.opt[COMPRESSION_PAR].cap |= Sane.CAP_INACTIVE
	      s.opt[THRESHOLD].cap &= ~Sane.CAP_INACTIVE
	      s.opt[HALFTONE_PATTERN].cap &= ~Sane.CAP_INACTIVE

	      s.opt[AUTOMATIC_THRESHOLD].cap &= ~Sane.CAP_INACTIVE
	      s.opt[WHITE_LEVEL].cap &= ~Sane.CAP_INACTIVE
	      s.opt[NOISE_REDUCTION].cap &= ~Sane.CAP_INACTIVE
	      s.opt[INVERSE].cap &= ~Sane.CAP_INACTIVE
	      s.opt[RED_CHROMA].cap |= Sane.CAP_INACTIVE
	      s.opt[BLUE_CHROMA].cap |= Sane.CAP_INACTIVE
	    }
	  else
	    {
	      s.opt[COMPRESSION].cap &= ~Sane.CAP_INACTIVE
	  ...
	  if(!strcmp(s.val[option].s, Sane.VALUE_SCAN_MODE_GRAY))
	    {
	      s.opt[INVERSE].cap &= ~Sane.CAP_INACTIVE
	...
	case STAPELED_DOC:
	  ...
	  if(strcmp(s.val[option].s, stapeled_list[0]) == 0)
	    {
	      s.opt[DBLFEED].cap &= ~Sane.CAP_INACTIVE
	      s.opt[DFSTOP].cap &= ~Sane.CAP_INACTIVE
	      s.opt[DFEED_L].cap &= ~Sane.CAP_INACTIVE
	      s.opt[DFEED_C].cap &= ~Sane.CAP_INACTIVE
	      s.opt[DFEED_C].cap &= ~Sane.CAP_INACTIVE
	      s.opt[DFEED_R].cap &= ~Sane.CAP_INACTIVE
	      s.opt[DFEED_SENCE].cap &= ~Sane.CAP_INACTIVE
	    }
	  else
	    {
	      s.opt[DBLFEED].cap |= Sane.CAP_INACTIVE
...
Sane.get_parameters(Sane.Handle handle, Sane.Parameters * params)
{
  ...
  p.format = !strcmp(s.val[MODE].s,
		       Sane.VALUE_SCAN_MODE_COLOR) ? Sane.FRAME_RGB :
    Sane.FRAME_GRAY
