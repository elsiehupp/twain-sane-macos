...
#define MD_RESOLUTION_DEFAULT   72 << Sane.FIXED_SCALE_SHIFT
#define MD_BRIGHTNESS_DEFAULT	100 << Sane.FIXED_SCALE_SHIFT
#define MD_CONTRAST_DEFAULT     100 << Sane.FIXED_SCALE_SHIFT
#define MD_THRESHOLD_DEFAULT    128
#define MD_GAMMA_DEFAULT        Sane.FIX(2.2)
...
enum Microtek2_Option
{
  ...
  /* Sane.control_option relies on it */
  OPT_CHANNEL,
  OPT_SHADOW,
  OPT_MIDTONE,
  OPT_HIGHLIGHT,
...
#define M_TITLE_SCANMODEGRP    Sane.I18N("Scan Mode")
#define M_TITLE_GEOMGRP        Sane.I18N("Geometry")
#define M_TITLE_ENHANCEGRP     Sane.I18N("Enhancement")
#define M_TITLE_SMHGRP         Sane.I18N("Shadow, midtone, highlight,"\
                                         " exposure time")
#define M_TITLE_SPECIALGRP     Sane.I18N("Special options")
#define M_TITLE_COLBALANCEGRP  Sane.I18N("Color balance")

#define M_NAME_NOBACKTRACK     "no-backtracking"
#define M_TITLE_NOBACKTRACK    Sane.I18N("Disable backtracking")
#define M_DESC_NOBACKTRACK     Sane.I18N("If checked the scanner does not" \
                               " perform backtracking")

#define M_NAME_TOGGLELAMP      "toggle-lamp"
#define M_TITLE_TOGGLELAMP     Sane.I18N("Toggle lamp of flatbed")
#define M_DESC_TOGGLELAMP      Sane.I18N("Toggles the lamp of the flatbed")

#define M_NAME_CALIBBACKEND    "backend-calibration"
#define M_TITLE_CALIBBACKEND   Sane.I18N("Calibration by backend")
#define M_DESC_CALIBBACKEND    Sane.I18N("If checked the color calibration" \
                               " before a scan is done by the backend")

#define M_NAME_LIGHTLID35      "lightlid35"
#define M_TITLE_LIGHTLID35     Sane.I18N("Use the lightlid-35mm adapter")
#define M_DESC_LIGHTLID35      Sane.I18N("This option turns off the lamp of" \
                               " the flatbed during a scan")

#define M_NAME_QUALITY_SCAN    "quality-scan"
#define M_TITLE_QUALITY_SCAN   Sane.I18N("Quality scan")
#define M_DESC_QUALITY_SCAN    Sane.I18N("Highest quality but lower speed")

#define M_NAME_FAST_SCAN       "fast-scan"
#define M_TITLE_FAST_SCAN      Sane.I18N("Fast scan")
#define M_DESC_FAST_SCAN       Sane.I18N("Highest speed but lower quality")

#define M_NAME_AUTOADJUST      "lineart-auto-adjust"
#define M_TITLE_AUTOADJUST     Sane.I18N("Automatic adjustment of threshold")
#define M_DESC_AUTOADJUST      Sane.I18N("If checked the backend automatically"\
                               " tries to determine an optimal value for the" \
                               " threshold.")

#define M_NAME_GAMMA_MODE      "gamma-correction"
#define M_TITLE_GAMMA_MODE     Sane.I18N("Gamma correction")
#define M_DESC_GAMMA_MODE      Sane.I18N("Selects the gamma correction mode.")

#define M_NAME_GAMMA_BIND      "bind-gamma"
#define M_TITLE_GAMMA_BIND     Sane.I18N("Bind gamma")
#define M_DESC_GAMMA_BIND      Sane.I18N("Use same gamma values for all" \
                               " colour channels.")

#define M_NAME_GAMMA_SCALAR    "scalar-gamma"
#define M_TITLE_GAMMA_SCALAR   Sane.I18N("Scalar gamma")
#define M_DESC_GAMMA_SCALAR    Sane.I18N("Selects a value for scalar" \
                               " gamma correction.")
...
#define M_DESC_CHANNEL         Sane.I18N("Selects the colour band, \"Master\"" \
                               " means that all colours are affected.")

#define M_NAME_MIDTONE         "midtone"
#define M_TITLE_MIDTONE        Sane.I18N("Midtone")
#define M_DESC_MIDTONE         Sane.I18N("Selects which radiance level should" \
                               " be considered \"50 % gray\".")

#define M_NAME_MIDTONE_R       "midtone-r"
#define M_TITLE_MIDTONE_R      Sane.I18N("Midtone for red")
#define M_DESC_MIDTONE_R       Sane.I18N("Selects which radiance level should" \
                               " be considered \"50 % red\".")

#define M_NAME_MIDTONE_G       "midtone-g"
#define M_TITLE_MIDTONE_G      Sane.I18N("Midtone for green")
#define M_DESC_MIDTONE_G       Sane.I18N("Selects which radiance level should" \
                               " be considered \"50 % green\".")

#define M_NAME_MIDTONE_B       "midtone-b"
#define M_TITLE_MIDTONE_B      Sane.I18N("Midtone for blue")
#define M_DESC_MIDTONE_B       Sane.I18N("Selects which radiance level should" \
                               " be considered \"50 % blue\".")

#define M_NAME_BALANCE_R       "balance-r"
#define M_TITLE_BALANCE_R      Sane.I18N("Red balance")
#define M_DESC_BALANCE_R       Sane.I18N("Balance factor for red. A value of" \
                               " 100% means no correction.")

#define M_NAME_BALANCE_G       "balance-g"
#define M_TITLE_BALANCE_G      Sane.I18N("Green balance")
#define M_DESC_BALANCE_G       Sane.I18N("Balance factor for green. A value of"\
                               " 100% means no correction.")

#define M_NAME_BALANCE_B       "balance-b"
#define M_TITLE_BALANCE_B      Sane.I18N("Blue balance")
#define M_DESC_BALANCE_B       Sane.I18N("Balance factor for blue. A value of" \
                               " 100% means no correction.")

#define M_NAME_BALANCE_FW      "balance-fw"
#define M_TITLE_BALANCE_FW     Sane.I18N("Firmware balance")
#define M_DESC_BALANCE_FW      Sane.I18N("Sets the color balance values to"\
...
typedef struct Microtek2_Info {
    /* from inquiry */
    Sane.Byte device_qualifier
#define MI_DEVTYPE_SCANNER             0x06
    Sane.Byte device_type
#define MI_SCSI_II_VERSION             0x02
    Sane.Byte scsi_version
    Sane.Char vendor[INQ_VENDOR_L + 1]
    Sane.Char model[INQ_MODEL_L + 1]
    Sane.Char revision[INQ_REV_L + 1]
    Sane.Byte model_code
    /* from read scanner attributes */
    Bool color
#define MI_HAS_ONEPASS                 Sane.TRUE
    Bool onepass
...
#define MI_TYPE_TRANSPARENCY           0x03
    Sane.Byte scanner_type
#define MI_HAS_FEPROM                  Sane.TRUE
    Bool feprom
...
#define MI_LUTCAP_UNKNOWN              128
    Sane.Byte lut_cap
#define MI_HAS_DNLDPTRN                Sane.TRUE
    Bool has_dnldptrn
    Sane.Byte grain_slct
...
#define MI_OPTDEV_SLIDE                0x80
    Sane.Byte option_device
    Int calib_white
    Int calib_space
    Sane.Byte nlens
    Sane.Byte nwindows
    Sane.Byte shtrnsferequ
#define MI_WHITE_SHADING_ONLY(x)       ((x) & 0x20) == 0
#define MI_HAS_SCNBTTN                 Sane.TRUE
    Bool scnbuttn
#define MI_HAS_PIPOBUF                 Sane.TRUE
    Bool buftype
    uint16_t balance[3];              /* balance factor for red, green */
                                       /* and blue data */
    uint16_t aps_maxframes
    Int calib_divisor;           /* e.g. the X12USL reads and sends */
...
#define MD_SOURCE_STRIPE              4
    ...
    Int *custom_gamma_table[4];      /* used for the custom gamma */
...
#define MD_MODESTRING_COLOR            Sane.VALUE_SCAN_MODE_COLOR
#define MD_MODESTRING_GRAY             Sane.VALUE_SCAN_MODE_GRAY
#define MD_MODESTRING_HALFTONE         Sane.VALUE_SCAN_MODE_HALFTONE
#define MD_MODESTRING_LINEART          Sane.VALUE_SCAN_MODE_LINEART
    Sane.String_Const scanmode_list[MD_MODESTRING_NUMS + 1]
...
#define MD_DEPTHVAL_4                  4
    Int bitdepth_list[MD_DEPTHVAL_NUMS + 1]
...
#define MD_CHANNEL_BLUE               "Blue"
    Sane.String_Const channel_list[MD_CHANNEL_NUMS + 1]
...
#define MD_GAMMAMODE_CUSTOM           "Custom"
    Sane.String_Const gammamode_list[MD_GAMMAMODE_NUMS + 1]

    Sane.Range x_res_range_dpi;           /* X resolution in dpi */
    Sane.Range y_res_range_dpi;           /* Y resolution in dpi */
    Sane.Range x_range_mm;                /* scan width in mm */
    Sane.Range y_range_mm;                /* scan height in mm */
    Sane.Range percentage_range;          /* for brightness, shadow, ... */
    Sane.Range custom_gamma_range;        /* for custom gamma values */
    Sane.Range scalar_gamma_range;        /* for scalar gamma values */
    Sane.Range shadow_range;              /* shadow of blue channel */
    Sane.Range midtone_range;             /* midtone shadow of blue channel */
    Sane.Range exposure_range;            /* for lengthening exposure time */
    Sane.Range highlight_range;           /* highlight of master channel */
    Sane.Range threshold_range;           /* 1 - 255 */
    Sane.Range balance_range;             /* for user provided color balance */
    Config_Options opts;                  /* options from the config file */
    Sane.Word opt_backend_calib_default;  /* corresponds to scanner model */
    Sane.Word opt_no_backtrack_default;   /* corresponds to scanner model */
} Microtek2_Device
...
typedef struct Microtek2_Scanner {
    ...
    Sane.Option_Descriptor sod[NUM_OPTIONS + 1]; /* option list for session */
...
#define MS_SOURCE_SLIDE                0x06
    ...
    Int mode
    Int depth
    Int x_resolution_dpi
    Int y_resolution_dpi
    Int x1_dots;            /* x-position in units of optical resolution */
    Int y1_dots;            /* same for y-position */
    Int width_dots;         /* scan width in units of optical resolution */
    Int height_dots;        /* same for height */
    ...
    Bool use_external_ht
    Sane.Byte internal_ht_index
    uint8_t stay
    uint8_t rawdat
    Bool quality
    Bool fastscan
    Sane.Byte scan_source
...
#define MS_COLOR_ALL                   3
    ...
    Int src_remaining_lines;  /* remaining lines to read */
    Int src_lines_to_read;    /* actual number of lines read */
    Int src_max_lines;        /* maximum number of lines that fit */
    ...
    Int scanning;             /* true == between Sane.start & Sane.read=EOF */
    Int cancelled
    Int sfd;                  /* SCSI filedescriptor */
    Int fd[2];                /* file descriptors for pipe */
    Sane.Pid pid;             /* pid of child process */
    FILE *fp
...
static Sane.Status
add_device_list(Sane.String_Const, Microtek2_Device **)
...
static Sane.Status
calculate_Sane.params(Microtek2_Scanner *)

static Sane.Status
cancel_scan(Microtek2_Scanner *)

static Sane.Status
check_inquiry(Microtek2_Device *, String *)
...
get_cshading_values(Microtek2_Scanner *,uint8_t, uint32_t, float, Int,
                    float *, float *);     /* (KF) new */
static Sane.Status
get_scan_mode_and_depth(Microtek2_Scanner *, Int *, Int *, Int *, Int *)
...
static Sane.Status
restore_gamma_options(Sane.Option_Descriptor *, Option_Value *)
...
set_option_dependencies(Microtek2_Scanner *,
                        Sane.Option_Descriptor *, Option_Value *)
