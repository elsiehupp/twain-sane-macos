...
TState WaitWhileBusy(TInstance *this, Int cSecs)
{
  ...
  return SetError(this,Sane.STATUS_IO_ERROR,"Timeout while waiting for CTL")
}
...
TState WaitWhileScanning(TInstance *this, Int cSecs)
{
  ...
  return SetError(this,Sane.STATUS_IO_ERROR,"Timeout while waiting for CSTAT")
}
...
__SM3600EXPORT__
TState UploadGammaTable(TInstance *this, Int iByteAddress, Int *pnGamma)
{
