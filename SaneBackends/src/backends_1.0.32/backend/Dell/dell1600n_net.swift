/*
  ...
  To debug:
  Sane.DEBUG_DELL1600N_NET=255 scanimage --verbose 2>scan.errs 1>scan.png
*/
...
/* version number */
#define DRIVER_VERSION Sane.VERSION_CODE( Sane.CURRENT_MAJOR, V_MINOR, 0 )
...
Sane.get_devices(const Sane.Device *** device_list, Bool local_only)
{
  ...
  /* report our finds */
  *device_list = (const Sane.Device **) gKnownDevices
...
Sane.open(Sane.String_Const devicename, Sane.Handle * handle)
{
  ...
  /* set the handle */
  *handle = (Sane.Handle) (unsigned long)iHandle
			    ...
			    Int option)
{
  ...
  static Sane.Option_Descriptor numOptions = {
    "num_options",
    "Number of options",
    "Number of options",
    Sane.TYPE_INT,
...
Sane.get_parameters(Sane.Handle handle, Sane.Parameters * params)
{
  ...
  DBG( 5, "Sane.get_parameters: bytes remaining on this page: %d, num pages: %d, size: %dx%d\n",
