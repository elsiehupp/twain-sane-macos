...
Sane.Status
sanei_pieusb_buffer_create(struct Pieusb_Read_Buffer* buffer, Int width, Int height, Sane.Byte color_spec, Sane.Byte depth)
{
    Int k, result
 ...
 */
Int
sanei_pieusb_buffer_put_single_color_line(struct Pieusb_Read_Buffer* buffer, Sane.Byte color, void* line, Int size)
{
 ...
 */
void
sanei_pieusb_buffer_get(struct Pieusb_Read_Buffer* buffer, Sane.Byte* data, Int max_len, Int* len)
{
    Sane.Byte *pdata
    Int n, i, n_bits, N
