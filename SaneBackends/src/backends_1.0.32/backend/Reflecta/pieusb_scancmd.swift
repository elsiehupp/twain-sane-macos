...
static void _prep_scsi_cmd(Sane.Byte* command_bytes, Sane.Byte command, Sane.Word size)
 ...
 */
static Sane.Byte
_get_byte(Sane.Byte* array, Sane.Byte offset) {
    return *(array+offset)
}
 ...
 */
static void
_set_byte(Sane.Byte val, Sane.Byte* array, Sane.Byte offset) {
    *(array+offset) = val
}
 ...
 * Int is 4 bytes, but that is not a problem.
 */
static Int
_get_short(Sane.Byte* array, Sane.Byte offset) {
 ...
 */
static void
_set_short(Sane.Word val, Sane.Byte* array, Sane.Byte offset) {
 ...
 */
static Int
_get_int(Sane.Byte* array, Sane.Byte offset) {
    Int i = *(array+offset+3)
    i <<= 8
    i += *(array+offset+2)
    i <<= 8
    i += *(array+offset+1)
 ...
 */
static void
_set_int(Sane.Word val, Sane.Byte* array, Sane.Byte offset) {
    *(array+offset) = val & 0xFF
    *(array+offset+1) = (val>>8) & 0xFF
 ...
 * Sane.Word is 4 bytes, but that is not a problem.
 */
static void
 ...
 * Sane.Word is 4 bytes, but that is not a problem. All MSB 2 bytes are ignored.
 */
static void
 ...
 * @return Pieusb_Command_Status Sane.STATUS_GOOD if ready, Sane.STATUS_DEVICE_BUSY if not
 */
void
sanei_pieusb_cmd_test_unit_ready(Int device_number, struct Pieusb_Command_Status *status)
{
...
void
sanei_pieusb_cmd_slide(Int device_number, slide_action action, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
 ...
 */
void
sanei_pieusb_cmd_get_sense(Int device_number, struct Pieusb_Sense* sense, struct Pieusb_Command_Status *status, PIEUSB_Status *ret)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
#define DATA_SIZE 14
    Int size = DATA_SIZE
    Sane.Byte data[DATA_SIZE]
    PIEUSB_Status st
  Sane.Char* sd
 ...
 */
void
sanei_pieusb_cmd_get_scan_frame(Int device_number, Int index, struct Pieusb_Scan_Frame* frame, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
...
void
sanei_pieusb_cmd_17(Int device_number, Int value, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
 ...
 */
void
sanei_pieusb_cmd_get_shading_parms(Int device_number, struct Pieusb_Shading_Parameters_Info* shading, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
#define SHADING_SIZE 32
#define PREP_READ_SIZE 6
    Int size = SHADING_SIZE
 ...
 */
void
sanei_pieusb_cmd_get_scanned_lines(Int device_number, Sane.Byte* data, Int lines, Int size, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
 ...
 */
void
sanei_pieusb_cmd_set_scan_frame(Int device_number, Int index, struct Pieusb_Scan_Frame* frame, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
 ...
 */
void
sanei_pieusb_cmd_set_exposure_time(Int device_number, struct Pieusb_Exposure_Time* time, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
#define EXPOSURE_DATA_SIZE 8
    Sane.Byte data[EXPOSURE_DATA_SIZE]
 ...
 */
void
sanei_pieusb_cmd_set_highlight_shadow(Int device_number, struct Pieusb_Highlight_Shadow* hgltshdw, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
#define HIGHLIGHT_SHADOW_SIZE 8
    Sane.Byte data[HIGHLIGHT_SHADOW_SIZE]
 ...
 */
void
sanei_pieusb_cmd_get_parameters(Int device_number, struct Pieusb_Scan_Parameters* parameters, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
 ...
 */
void
sanei_pieusb_cmd_inquiry(Int device_number, struct Pieusb_Scanner_Properties* inq, Sane.Byte size, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
#define INQUIRY_SIZE 256
    ...
    _copy_bytes((Sane.Byte*)(inq.vendor), data+8, 8); /* Note: not 0-terminated */
    _copy_bytes((Sane.Byte*)(inq.product), data+16, 16); /* Note: not 0-terminated */
    _copy_bytes((Sane.Byte*)(inq.productRevision), data+32, 4); /* Note: not 0-terminated */
    ...
    _copy_bytes((Sane.Byte*)(inq.production), data+120, 4)
 ...
 */
void
sanei_pieusb_cmd_set_mode(Int device_number, struct Pieusb_Mode* mode, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
#define MODE_SIZE 16
    Int size = MODE_SIZE
 ...
 */
void
sanei_pieusb_cmd_get_ccd_mask(Int device_number, Sane.Byte* mask, Int mask_size, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
 ...
 */
void
sanei_pieusb_cmd_get_mode(Int device_number, struct Pieusb_Mode* mode, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
#define MODE_SIZE 16
    Int size = MODE_SIZE
 ...
 */
void
sanei_pieusb_cmd_start_scan(Int device_number, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
 ...
 */
void
sanei_pieusb_cmd_stop_scan(Int device_number, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
 ...
 */
void
sanei_pieusb_cmd_set_scan_head(Int device_number, Int mode, Int steps, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
 ...
 */
void
sanei_pieusb_cmd_get_gain_offset(Int device_number, struct Pieusb_Settings* settings, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
#define GAIN_OFFSET_SIZE 103
    Int size = GAIN_OFFSET_SIZE
    Sane.Byte data[GAIN_OFFSET_SIZE]
    Int k
    Sane.Byte val[3]
 ...
 */
void
sanei_pieusb_cmd_set_gain_offset(Int device_number, struct Pieusb_Settings* settings, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
 ...
 */
void
sanei_pieusb_cmd_read_state(Int device_number, struct Pieusb_Scanner_State* state, struct Pieusb_Command_Status *status)
{
    Sane.Byte command[SCSI_COMMAND_LEN]
