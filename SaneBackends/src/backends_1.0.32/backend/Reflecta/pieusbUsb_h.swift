...
Sane.Status sanei_pieusb_usb_reset(Int device_number)

Sane.Status sanei_pieusb_convert_status(PIEUSB_Status status)

String sanei_pieusb_decode_sense(struct Pieusb_Sense* sense, PIEUSB_Status *status)

PIEUSB_Status sanei_pieusb_command(Int device_number, Sane.Byte command[], Sane.Byte data[], Int size)
