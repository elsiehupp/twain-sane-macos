...
#define RGBI                0x0f
    ...
    Sane.Word gamma[4096];	/* gamma value for RGB */
    Sane.Word gamma_r[4096];	/* gamma value for red */
    Sane.Word gamma_g[4096];	/* gamma value for green */
    Sane.Word gamma_b[4096];	/* gamma value for blue */
...
#define length_quant Sane.UNFIX(Sane.FIX(MM_PER_INCH / 2700.0))
...
static Sane.String_Const type_list[] =
{
  positiveStr,
  negativeStr,
  0
...
static Sane.String_Const scan_mode_list_LS20[] =
{
  colorStr,
  grayStr,
  NULL
...
static Sane.String_Const scan_mode_list_LS30[] =
{
  colorStr,
  grayStr,
#ifdef HAS_IRED
...
static Sane.String_Const autofocus_mode_list[] =
{
  neverStr,
  previewStr,
  scanStr,
...
static const Sane.Range gamma_range_8 =
{
  0,				/* minimum */
  255,				/* maximum */
  1				/* quantization */
...
static const Sane.Range gamma_range_9 =
{
  0,				/* minimum */
  511,				/* maximum */
  1				/* quantization */
...
static const Sane.Range gamma_range_10 =
{
  0,				/* minimum */
  1023,				/* maximum */
  1				/* quantization */
...
static const Sane.Range gamma_range_12 =
{
  0,				/* minimum */
  4096,				/* maximum */
  1				/* quantization */
...
static const Sane.Range shift_range =
{
  -15,
  +15,
  0
...
init_options(Coolscan_t * scanner)
{
  ...
  scanner.opt[OPT_PRESCAN].type = Sane.TYPE_BOOL
  scanner.opt[OPT_PRESCAN].unit = Sane.UNIT_NONE
  ...
  scanner.opt[OPT_PRESCAN_NOW].type = Sane.TYPE_BUTTON
  scanner.opt[OPT_PRESCAN_NOW].unit = Sane.UNIT_NONE
  scanner.opt[OPT_PRESCAN_NOW].size = 0
  scanner.opt[OPT_PRESCAN_NOW].cap = Sane.CAP_SOFT_SELECT | Sane.CAP_SOFT_DETECT
  scanner.opt[OPT_PRESCAN_NOW].constraint_type = Sane.CONSTRAINT_NONE
 ...
 /* bit depth */
  ...
  scanner.opt[OPT_RESOLUTION].type = Sane.TYPE_INT
  scanner.opt[OPT_RESOLUTION].unit = Sane.UNIT_DPI
  scanner.opt[OPT_RESOLUTION].constraint_type = Sane.CONSTRAINT_WORD_LIST
  ...
  scanner.opt[OPT_PREVIEW_RESOLUTION].desc = Sane.DESC_SCAN_RESOLUTION
  scanner.opt[OPT_PREVIEW_RESOLUTION].type = Sane.TYPE_INT
  scanner.opt[OPT_PREVIEW_RESOLUTION].unit = Sane.UNIT_DPI
  scanner.opt[OPT_PREVIEW_RESOLUTION].constraint_type = Sane.CONSTRAINT_WORD_LIST
  ...
  scanner.opt[OPT_GAMMA_BIND].type = Sane.TYPE_BOOL
  scanner.opt[OPT_GAMMA_BIND].unit = Sane.UNIT_NONE
  ...
  scanner.opt[OPT_AVERAGING].type = Sane.TYPE_BOOL
  scanner.opt[OPT_AVERAGING].unit = Sane.UNIT_NONE
  ...
  scanner.opt[OPT_RGB_CONTROL].type = Sane.TYPE_BOOL
  scanner.opt[OPT_RGB_CONTROL].unit = Sane.UNIT_NONE
  if(scanner.LS>=2)
  {  scanner.opt[OPT_RGB_CONTROL].cap |= Sane.CAP_INACTIVE
  }
  ...
  scanner.opt[OPT_BRIGHTNESS].type = Sane.TYPE_INT
  scanner.opt[OPT_BRIGHTNESS].unit = Sane.UNIT_NONE
  ...
  scanner.opt[OPT_R_BRIGHTNESS].desc = Sane.DESC_BRIGHTNESS
  scanner.opt[OPT_R_BRIGHTNESS].type = Sane.TYPE_INT
  scanner.opt[OPT_R_BRIGHTNESS].unit = Sane.UNIT_NONE
  scanner.opt[OPT_R_BRIGHTNESS].constraint_type = Sane.CONSTRAINT_RANGE
  scanner.opt[OPT_R_BRIGHTNESS].constraint.range = &brightness_range
  scanner.opt[OPT_R_BRIGHTNESS].cap |= Sane.CAP_INACTIVE

  scanner.opt[OPT_G_BRIGHTNESS].name = "green-brightness"
  scanner.opt[OPT_G_BRIGHTNESS].title = "Green brightness"
  scanner.opt[OPT_G_BRIGHTNESS].desc = Sane.DESC_BRIGHTNESS
  scanner.opt[OPT_G_BRIGHTNESS].type = Sane.TYPE_INT
  scanner.opt[OPT_G_BRIGHTNESS].unit = Sane.UNIT_NONE
  scanner.opt[OPT_G_BRIGHTNESS].constraint_type = Sane.CONSTRAINT_RANGE
  scanner.opt[OPT_G_BRIGHTNESS].constraint.range = &brightness_range
  scanner.opt[OPT_G_BRIGHTNESS].cap |= Sane.CAP_INACTIVE

  scanner.opt[OPT_B_BRIGHTNESS].name = "blue-brightness"
  scanner.opt[OPT_B_BRIGHTNESS].title = "Blue brightness"
  scanner.opt[OPT_B_BRIGHTNESS].desc = Sane.DESC_BRIGHTNESS
  scanner.opt[OPT_B_BRIGHTNESS].type = Sane.TYPE_INT
  scanner.opt[OPT_B_BRIGHTNESS].unit = Sane.UNIT_NONE
  scanner.opt[OPT_B_BRIGHTNESS].constraint_type = Sane.CONSTRAINT_RANGE
  scanner.opt[OPT_B_BRIGHTNESS].constraint.range = &brightness_range
  scanner.opt[OPT_B_BRIGHTNESS].cap |= Sane.CAP_INACTIVE
  ...
  scanner.opt[OPT_CONTRAST].type = Sane.TYPE_INT
  scanner.opt[OPT_CONTRAST].unit = Sane.UNIT_NONE
  ...
  scanner.opt[OPT_R_CONTRAST].desc = Sane.DESC_CONTRAST
  scanner.opt[OPT_R_CONTRAST].type = Sane.TYPE_INT
  scanner.opt[OPT_R_CONTRAST].unit = Sane.UNIT_NONE
  scanner.opt[OPT_R_CONTRAST].constraint_type = Sane.CONSTRAINT_RANGE
  scanner.opt[OPT_R_CONTRAST].constraint.range = &contrast_range
  scanner.opt[OPT_R_CONTRAST].cap |= Sane.CAP_INACTIVE

  scanner.opt[OPT_G_CONTRAST].name = "green-contrast"
  scanner.opt[OPT_G_CONTRAST].title = "Green contrast"
  scanner.opt[OPT_G_CONTRAST].desc = Sane.DESC_CONTRAST
  scanner.opt[OPT_G_CONTRAST].type = Sane.TYPE_INT
  scanner.opt[OPT_G_CONTRAST].unit = Sane.UNIT_NONE
  scanner.opt[OPT_G_CONTRAST].constraint_type = Sane.CONSTRAINT_RANGE
  scanner.opt[OPT_G_CONTRAST].constraint.range = &contrast_range
  scanner.opt[OPT_G_CONTRAST].cap |= Sane.CAP_INACTIVE

  scanner.opt[OPT_B_CONTRAST].name = "blue-contrast"
  scanner.opt[OPT_B_CONTRAST].title = "Blue contrast"
  scanner.opt[OPT_B_CONTRAST].desc = Sane.DESC_CONTRAST
  scanner.opt[OPT_B_CONTRAST].type = Sane.TYPE_INT
  scanner.opt[OPT_B_CONTRAST].unit = Sane.UNIT_NONE
  scanner.opt[OPT_B_CONTRAST].constraint_type = Sane.CONSTRAINT_RANGE
  scanner.opt[OPT_B_CONTRAST].constraint.range = &contrast_range
  scanner.opt[OPT_B_CONTRAST].cap |= Sane.CAP_INACTIVE

  scanner.opt[OPT_EXPOSURE].name = "exposure"
  scanner.opt[OPT_EXPOSURE].title = "Exposure"
  scanner.opt[OPT_EXPOSURE].desc = ""
  scanner.opt[OPT_EXPOSURE].type = Sane.TYPE_INT
  scanner.opt[OPT_EXPOSURE].cap &= ~Sane.CAP_INACTIVE
  scanner.opt[OPT_EXPOSURE].unit = Sane.UNIT_PERCENT
  scanner.opt[OPT_EXPOSURE].constraint_type = Sane.CONSTRAINT_RANGE
  ...
  scanner.opt[OPT_R_EXPOSURE].type = Sane.TYPE_INT
  scanner.opt[OPT_R_EXPOSURE].cap |= Sane.CAP_INACTIVE
  scanner.opt[OPT_R_EXPOSURE].unit = Sane.UNIT_PERCENT
  scanner.opt[OPT_R_EXPOSURE].constraint_type = Sane.CONSTRAINT_RANGE
  ...
  scanner.opt[OPT_G_EXPOSURE].type = Sane.TYPE_INT
  scanner.opt[OPT_G_EXPOSURE].unit = Sane.UNIT_PERCENT
  scanner.opt[OPT_G_EXPOSURE].constraint_type = Sane.CONSTRAINT_RANGE
  ...
  scanner.opt[OPT_B_EXPOSURE].type = Sane.TYPE_INT
  scanner.opt[OPT_B_EXPOSURE].unit = Sane.UNIT_PERCENT
  scanner.opt[OPT_B_EXPOSURE].constraint_type = Sane.CONSTRAINT_RANGE
  ...
  scanner.opt[OPT_R_SHIFT].type = Sane.TYPE_INT
  scanner.opt[OPT_R_SHIFT].unit = Sane.UNIT_NONE
  scanner.opt[OPT_R_SHIFT].constraint_type = Sane.CONSTRAINT_RANGE
  scanner.opt[OPT_R_SHIFT].constraint.range = &shift_range
  if(scanner.LS>=2)
  {  scanner.opt[OPT_R_SHIFT].cap |= Sane.CAP_INACTIVE
  }
  ...
  scanner.opt[OPT_G_SHIFT].type = Sane.TYPE_INT
  scanner.opt[OPT_G_SHIFT].unit = Sane.UNIT_NONE
  scanner.opt[OPT_G_SHIFT].constraint_type = Sane.CONSTRAINT_RANGE
  scanner.opt[OPT_G_SHIFT].constraint.range = &shift_range
  if(scanner.LS>=2)
  {  scanner.opt[OPT_G_SHIFT].cap |= Sane.CAP_INACTIVE
  }
  ...
  scanner.opt[OPT_B_SHIFT].type = Sane.TYPE_INT
  scanner.opt[OPT_B_SHIFT].unit = Sane.UNIT_NONE
  scanner.opt[OPT_B_SHIFT].constraint_type = Sane.CONSTRAINT_RANGE
  scanner.opt[OPT_B_SHIFT].constraint.range = &shift_range
  if(scanner.LS>=2)
  {  scanner.opt[OPT_B_SHIFT].cap |= Sane.CAP_INACTIVE
  }
  ...
  scanner.opt[OPT_IRED_RED].type = Sane.TYPE_INT
  scanner.opt[OPT_IRED_RED].unit = Sane.UNIT_NONE
  scanner.opt[OPT_IRED_RED].constraint_type = Sane.CONSTRAINT_RANGE
  scanner.opt[OPT_IRED_RED].constraint.range = &gamma_range_8
  scanner.opt[OPT_IRED_RED].cap |= Sane.CAP_ADVANCED
  if(scanner.LS<2)
  {  scanner.opt[OPT_IRED_RED].cap |= Sane.CAP_INACTIVE
  }
...
/*
   static void
   worddump(char *comment, Sane.Word * p, Int l)
   {
   var i: Int
   char line[128]
   char *ptr
		     ...
		     Int * info)
{
  ...
  if(action == Sane.ACTION_GET_VALUE)
	...
	case OPT_BIT_DEPTH:
	  *(Sane.Word *) val = scanner.bits_per_color
	  return Sane.STATUS_GOOD

	case OPT_CONTRAST:
	  *(Sane.Word *) val = scanner.contrast - 128
	  return Sane.STATUS_GOOD

	case OPT_R_CONTRAST:
	  *(Sane.Word *) val = scanner.contrast_R - 128
	  return Sane.STATUS_GOOD

	case OPT_G_CONTRAST:
	  *(Sane.Word *) val = scanner.contrast_G - 128
	  return Sane.STATUS_GOOD

	case OPT_B_CONTRAST:
	  *(Sane.Word *) val = scanner.contrast_B - 128
	  return Sane.STATUS_GOOD

	case OPT_BRIGHTNESS:
	  *(Sane.Word *) val = scanner.brightness - 128
	  return Sane.STATUS_GOOD

	case OPT_R_BRIGHTNESS:
	  *(Sane.Word *) val = scanner.brightness_R - 128
	  return Sane.STATUS_GOOD

	case OPT_G_BRIGHTNESS:
	  *(Sane.Word *) val = scanner.brightness_G - 128
	  return Sane.STATUS_GOOD

	case OPT_B_BRIGHTNESS:
	  *(Sane.Word *) val = scanner.brightness_B - 128
	  return Sane.STATUS_GOOD

	case OPT_EXPOSURE:
	  *(Sane.Word *) val = scanner.exposure_R * 2
	  return Sane.STATUS_GOOD
	...
	case OPT_G_EXPOSURE:
	  *(Sane.Word *) val = scanner.exposure_G * 2
	  return Sane.STATUS_GOOD

	case OPT_B_EXPOSURE:
	  *(Sane.Word *) val = scanner.exposure_B * 2
	  return Sane.STATUS_GOOD

	case OPT_R_SHIFT:
	  *(Sane.Word *) val = scanner.shift_R - 128
	  return Sane.STATUS_GOOD

	case OPT_G_SHIFT:
	  *(Sane.Word *) val = scanner.shift_G - 128
	  return Sane.STATUS_GOOD

	case OPT_B_SHIFT:
	  *(Sane.Word *) val = scanner.shift_B - 128
	  return Sane.STATUS_GOOD


	case OPT_IRED_RED:
	  *(Sane.Word *) val = scanner.ired_red
	  return Sane.STATUS_GOOD
	...
	case OPT_PRESCAN:
	  *(Sane.Word *) val = (scanner.prescan) ? Sane.TRUE : Sane.FALSE
	  return Sane.STATUS_GOOD
	...
	case OPT_RGB_CONTROL:
	  *(Sane.Word *) val = (scanner.rgb_control) ? Sane.TRUE : Sane.FALSE
	  return Sane.STATUS_GOOD

	case OPT_GAMMA_BIND:
	  *(Sane.Word *) val = (scanner.gamma_bind) ? Sane.TRUE : Sane.FALSE
	  return Sane.STATUS_GOOD

	case OPT_ANALOG_GAMMA:
	  *(Sane.Word *) val =
	    (scanner.analog_gamma_r) ? Sane.TRUE : Sane.FALSE
	  return Sane.STATUS_GOOD

	case OPT_AVERAGING:
	  *(Sane.Word *) val = (scanner.averaging) ? Sane.TRUE : Sane.FALSE
	  return Sane.STATUS_GOOD
	...
	case OPT_ANALOG_GAMMA:
	  scanner.analog_gamma_r = scanner.analog_gamma_g =
	    scanner.analog_gamma_b = (*(Sane.Word *) val == Sane.TRUE)
	  return Sane.STATUS_GOOD

	case OPT_AVERAGING:
	  scanner.averaging = (*(Sane.Word *) val == Sane.TRUE)
	  return Sane.STATUS_GOOD

	case OPT_PRESCAN:
	  scanner.prescan = (*(Sane.Word *) val == Sane.TRUE)
	  return Sane.STATUS_GOOD
	...
	case OPT_CONTRAST:
	  scanner.contrast = *(Sane.Word *) val + 128
	  return Sane.STATUS_GOOD
	case OPT_R_CONTRAST:
	  scanner.contrast_R = *(Sane.Word *) val + 128
	  return Sane.STATUS_GOOD
	case OPT_G_CONTRAST:
	  scanner.contrast_G = *(Sane.Word *) val + 128
	  return Sane.STATUS_GOOD
	case OPT_B_CONTRAST:
	  scanner.contrast_B = *(Sane.Word *) val + 128
	  return Sane.STATUS_GOOD

	case OPT_BRIGHTNESS:
	  scanner.brightness = *(Sane.Word *) val + 128
	  return Sane.STATUS_GOOD
	case OPT_R_BRIGHTNESS:
	  scanner.brightness_R = *(Sane.Word *) val + 128
	  return Sane.STATUS_GOOD
	case OPT_G_BRIGHTNESS:
	  scanner.brightness_G = *(Sane.Word *) val + 128
	  return Sane.STATUS_GOOD
	case OPT_B_BRIGHTNESS:
	  scanner.brightness_B = *(Sane.Word *) val + 128
	  return Sane.STATUS_GOOD

	case OPT_EXPOSURE:
	  scanner.exposure_R = *(Sane.Word *) val / 2
	  scanner.exposure_G = *(Sane.Word *) val / 2
	  scanner.exposure_B = *(Sane.Word *) val / 2
	  return Sane.STATUS_GOOD
	case OPT_R_EXPOSURE:
	  scanner.exposure_R = *(Sane.Word *) val / 2
	  return Sane.STATUS_GOOD
	...
	case OPT_R_SHIFT:
	  scanner.shift_R = *(Sane.Word *) val + 128
	  return Sane.STATUS_GOOD
	case OPT_G_SHIFT:
	  scanner.shift_G = *(Sane.Word *) val + 128
	  return Sane.STATUS_GOOD
	case OPT_B_SHIFT:
	  scanner.shift_B = *(Sane.Word *) val + 128
	  return Sane.STATUS_GOOD

	case OPT_IRED_RED:
	  scanner.ired_red= *(Sane.Word *) val
	  return Sane.STATUS_GOOD
