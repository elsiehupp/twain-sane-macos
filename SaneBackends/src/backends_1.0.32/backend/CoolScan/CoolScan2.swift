...
typedef struct
{
  ...
  /* settings */
  Bool preview, negative, infrared
  ...
  /* SANE stuff */
  Sane.Option_Descriptor option_list[CS2_N_OPTIONS]
}
cs2_t
...
/* XXXXXXXXXXXXXXXXX do this for all elements of arrays */
	...
	case CS2_OPTION_INFRARED:
	  ...
	  /*      flags |= Sane.INFO_RELOAD_PARAMS; XXXXXXXXXXXXXXXXX */
	  break
	case CS2_OPTION_SAMPLES_PER_SCAN:
