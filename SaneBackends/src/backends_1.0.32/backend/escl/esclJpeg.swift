...
static void
term_source(j_decompress_ptr __Sane.unused__ cinfo)
{
    return
}

static void
init_source(j_decompress_ptr __Sane.unused__ cinfo)
{
    return
}
 ...
 * \brief Called in the "escl_Sane.decompressor" function.
 */
static void
...
static void
output_no_message(j_common_ptr __Sane.unused__ cinfo)
{
}
...
Sane.Status
get_JPEG_data(capabilities_t __Sane.unused__ *scanner,
