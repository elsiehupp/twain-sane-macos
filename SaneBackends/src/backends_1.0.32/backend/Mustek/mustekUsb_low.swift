...
usb_low_init(ma1017 ** chip_address)
{
  ...
  *chip_address = chip
  ...
  /* io */
  chip.is_rowing = Sane.FALSE
  chip.is_opened = Sane.FALSE
  chip.fd = -1
  ...
  for(i = 0; i < 32; i++)
    chip.is_transfer_table[i] = Sane.FALSE
...
{
  Sane.Byte pattern = ((Sane.Byte) index) << 4
  Sane.Byte reg_no = 0
  Sane.Status status
...
/* A2 */
Sane.Status
usb_low_get_a2 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
Sane.Status
usb_low_set_fix_pattern(ma1017 * chip, Bool is_fix)
{
  Sane.Byte data, reg_no
  Sane.Status status
...
Sane.Status
usb_low_adjust_timing(ma1017 * chip, Sane.Byte data)
{
  Sane.Status status
  Sane.Byte reg_no
...
/* A4 */
Sane.Status
usb_low_get_a4 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Status status
  Sane.Byte pattern
...
Sane.Status
usb_low_select_timing(ma1017 * chip, Sane.Byte data)
{
  Sane.Status status
  Sane.Byte reg_no
...
/* A6 */
Sane.Status
usb_low_get_a6 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
Sane.Status
usb_low_set_asic_io_pins(ma1017 * chip, Sane.Byte data)
{
  Sane.Status status
  Sane.Byte reg_no
...
Sane.Status
usb_low_set_rgb_sel_pins(ma1017 * chip, Sane.Byte data)
{
  Sane.Status status
  Sane.Byte reg_no
  ...
  return Sane.STATUS_GOOD;	/* was false? */
}

/* A7 */
Sane.Status
usb_low_get_a7 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
Sane.Status
usb_low_set_timing(ma1017 * chip, Sane.Byte data)
{
  Sane.Status status
  Sane.Byte reg_no
...
usb_low_set_cmt_table_length(ma1017 * chip, Sane.Byte table_length)
{
  ...
  chip.cmt_table_length_word = (Sane.Word) table_length
...
/* A9 */
Sane.Status
usb_low_get_a9 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
usb_low_set_cmt_second_position(ma1017 * chip, Sane.Byte position)
{
  ...
  chip.cmt_second_pos_word = (Sane.Word) (position)
...
/* A10 + A8ID5 */
Sane.Status
usb_low_get_a10 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
Sane.Status
usb_low_set_ccd_width(ma1017 * chip, Sane.Word ccd_width)
{
  Sane.Status status
  Sane.Byte data, reg_no
...
/* A11 + A8ID6 */
Sane.Status
usb_low_get_a11 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
  ...
  chip.dummy =
    ((Sane.Word) (pattern)) * 32 + ((chip.dummy_msb == 0) ? 0 : 0x0100 * 32)
...
Sane.Status
usb_low_set_dummy(ma1017 * chip, Sane.Word dummy)
{
  Sane.Status status
  Sane.Byte data, reg_no
...
/* A12 + A13 */
Sane.Status
usb_low_get_a12 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
  ...
  chip.byte_width = (chip.byte_width & 0x3f00) + ((Sane.Word) pattern)
...
Sane.Status
usb_low_get_a13 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
  ...
  chip.byte_width =
    (chip.byte_width & 0x00ff) + (((Sane.Word) (pattern & 0x3f)) << 8)
  chip.soft_resample = (chip.soft_resample == 0) ? 1 : chip.soft_resample
  chip.get_row =
    (chip.soft_resample ==
...
/* A15 */
Sane.Status
usb_low_get_a15 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
Sane.Status
usb_low_enable_motor(ma1017 * chip, Bool is_enable)
{
  Sane.Byte data, reg_no
  Sane.Status status
...
Sane.Status
usb_low_set_motor_signal(ma1017 * chip, Sane.Byte signal)
{
  Sane.Byte data, reg_no
  Sane.Status status
...
Sane.Status
usb_low_invert_image(ma1017 * chip, Bool is_invert)
{
  Sane.Byte data, reg_no
  Sane.Status status
...
/* A17 + A18 + A19 */
Sane.Status
usb_low_get_a17 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
Sane.Status
usb_low_get_a19 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
Sane.Status
usb_low_set_red_ref(ma1017 * chip, Sane.Byte red_ref)
{
  Sane.Byte data, reg_no
  Sane.Status status
...
Sane.Status
usb_low_set_green_ref(ma1017 * chip, Sane.Byte green_ref)
{
  Sane.Byte data, reg_no
  Sane.Status status
...
Sane.Status
usb_low_set_blue_ref(ma1017 * chip, Sane.Byte blue_ref)
{
  Sane.Byte data, reg_no
  Sane.Status status
...
/* A20 + A21 + A22 */
Sane.Status
usb_low_get_a20 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
Sane.Status
usb_low_get_a21 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
Sane.Status
usb_low_get_a22 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
Sane.Status
usb_low_set_red_pd(ma1017 * chip, Sane.Byte red_pd)
{
  Sane.Byte data, reg_no
  Sane.Status status
...
Sane.Status
usb_low_set_green_pd(ma1017 * chip, Sane.Byte green_pd)
{
  Sane.Byte data, reg_no
  Sane.Status status
...
Sane.Status
usb_low_set_blue_pd(ma1017 * chip, Sane.Byte blue_pd)
{
  Sane.Byte data, reg_no
  Sane.Status status
...
/* A23 */
Sane.Status
usb_low_get_a23 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
Sane.Status
usb_low_turn_lamp_power(ma1017 * chip, Bool is_on)
{
  Sane.Byte data, reg_no
  Sane.Status status
...
Sane.Status
usb_low_set_io_3 (ma1017 * chip, Bool is_high)
{
  Sane.Byte data, reg_no
  Sane.Status status
...
/* A24 */
Sane.Status
usb_low_get_a24 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
Sane.Status
usb_low_set_ad_timing(ma1017 * chip, Sane.Byte data)
{
  Sane.Byte reg_no
  Sane.Status status
...
/* A25 + A26 */
Sane.Status
usb_low_set_serial_byte1 (ma1017 * chip, Sane.Byte data)
{
  Sane.Byte reg_no
  Sane.Status status
...
Sane.Status
usb_low_set_serial_byte2 (ma1017 * chip, Sane.Byte data)
{
  Sane.Byte reg_no
  Sane.Status status
...
/* A27 */
Sane.Status
usb_low_get_a27 (ma1017 * chip, Sane.Byte * value)
{
  Sane.Byte pattern
  Sane.Status status
...
Sane.Status
usb_low_set_serial_format(ma1017 * chip, Sane.Byte data)
{
  Sane.Byte reg_no
  Sane.Status status
...
{
  Sane.Word line_of_first = 0
  Sane.Word line_of_second = 0
  Int i
  Sane.Status status
  ...
  chip.total_lines =
    ((Sane.Word) (chip.loop_count - 1)) * line_of_second + line_of_first
...
usb_low_get_row_resample(ma1017 * chip, Sane.Byte * data,
			  Sane.Word * lines_left)
{
  static Sane.Byte resample_buffer[8 * 1024]
  Sane.Word *pixel_temp
  Sane.Word i
  Sane.Word j
  Sane.Word k
  Sane.Status status
  ...
  if(chip.lines_left <= 1)
	...
	{
	  pixel_temp = (Sane.Word *) malloc(6 * 1024 * sizeof(Sane.Word))
	  if(!pixel_temp)
	    return Sane.STATUS_NO_MEM
	  ...
	  for(i = 0; i < chip.byte_width; i += 3)
	    {
	      pixel_temp[j] = (Sane.Word) resample_buffer[i]
	      pixel_temp[j] |= ((Sane.Word)
				(resample_buffer[i + 1] & 0xf0)) << 4
	      j++
	      pixel_temp[j] = ((Sane.Word)
			       (resample_buffer[i + 1] & 0x0f)) << 8
	      pixel_temp[j] |= (Sane.Word) resample_buffer[i + 2]
	      j++
	    }
	  ...
	  for(i = 0; i < j; i += chip.soft_resample * 2)
	    {
	      data[k] = (Sane.Byte) (pixel_temp[i] & 0x00ff)
	      k++
	      data[k] = (Sane.Byte) ((pixel_temp[i] & 0x0f00) >> 4)
	      data[k] |= (Sane.Byte) ((pixel_temp[i + 2] & 0x0f00) >> 8)
	      k++
	      data[k] = (Sane.Byte) (pixel_temp[i + 2] & 0x00ff)
	      k++
	    }
	  free(pixel_temp)
	}
	  ...
	  for(i = 0; i < chip.byte_width; i += 3)
	    {
	      pixel_temp[j] = (Sane.Word) resample_buffer[i]
	      pixel_temp[j] |=
		((Sane.Word) (resample_buffer[i + 1] & 0xf0)) << 4
	      j++
	      pixel_temp[j] =
		((Sane.Word) (resample_buffer[i + 1] & 0x0f)) << 8
	      pixel_temp[j] |= (Sane.Word) resample_buffer[i + 2]
	      j++
	    }
...
usb_low_read_rows(ma1017 * chip, Sane.Byte * data, Sane.Word byte_count)
{
  ...
  if(!(chip.is_opened))
    {
      DBG(3, "usb_low_read_rows: is_opened==Sane.FALSE\n")
      return Sane.STATUS_INVAL
    }
  if(!(chip.is_rowing))
    {
      DBG(3, "usb_low_read_rows: is_rowing==Sane.FALSE\n")
      return Sane.STATUS_INVAL
    }
  ...
  while((Sane.Word) bytes_total < byte_count)
    {
      status =
	sanei_usb_read_bulk(chip.fd, (Sane.Byte *) (data + bytes_total),
			     &n)
      if(status != Sane.STATUS_GOOD)
	{
	 ...
	 bigger chunks here but the scanner can only handle 64 bytes at once. */
      ...
      bytes_total += n
      if((Sane.Word) bytes_total != byte_count)
	{
	  DBG(7, "usb_low_read_rows:  wanted %d, got %d "
	       "bytes(%d in total) -- retrying\n", byte_count, (Sane.Word) n,
	       (Sane.Word) bytes_total)
	}
      n = MIN((byte_count - (Sane.Word) bytes_total), chip.max_block_size)
    }
...
{
  Sane.Status status
  Sane.Word devvendor, devproduct
  Mustek_Type devtype
...
Sane.Status
usb_low_open(ma1017 * chip, Sane.String_Const devname)
{
  Sane.Status status
  ...
  status = sanei_usb_open((Sane.String_Const) devname, &chip.fd)
...
usb_low_close(ma1017 * chip)
{
  ...
  if(chip.fd >= 0)
	...
	usb_low_set_fix_pattern(chip, Sane.FALSE)
      sanei_usb_close(chip.fd)
      chip.fd = -1
    }
  chip.is_opened = Sane.FALSE
