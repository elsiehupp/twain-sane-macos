...
import mustek_usb_low.c"

/* ------------------ sensor NEC 3797 600 CIS functions ------------------- */

static Sane.Word usb_mid_n600_optical_x_dpi[] =
...
usb_mid_n600_prepare_rgb_600_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_image_dpi (chip, Sane.TRUE, SW_P6P6))
  RIE (usb_low_set_soft_resample (chip, 1))
  RIE (usb_low_set_led_light_all (chip, Sane.FALSE))
...
usb_mid_n600_prepare_rgb_400_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_image_dpi (chip, Sane.TRUE, SW_P4P6))
  RIE (usb_low_set_soft_resample (chip, 1))
  RIE (usb_low_set_led_light_all (chip, Sane.FALSE))
...
usb_mid_n600_prepare_rgb_300_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_image_dpi (chip, Sane.TRUE, SW_P3P6))
  RIE (usb_low_set_soft_resample (chip, 1))
  RIE (usb_low_set_led_light_all (chip, Sane.FALSE))
...
usb_mid_n600_prepare_rgb_200_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_image_dpi (chip, Sane.TRUE, SW_P2P6))
  RIE (usb_low_set_soft_resample (chip, 1))
  RIE (usb_low_set_led_light_all (chip, Sane.FALSE))
...
usb_mid_n600_prepare_rgb_100_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_image_dpi (chip, Sane.TRUE, SW_P1P6))
  RIE (usb_low_set_soft_resample (chip, 1))
  RIE (usb_low_set_led_light_all (chip, Sane.FALSE))
...
usb_mid_n600_prepare_mono_600_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_image_dpi (chip, Sane.TRUE, SW_P6P6))
  RIE (usb_low_set_soft_resample (chip, 1))
  RIE (usb_low_set_led_light_all (chip, Sane.TRUE))
...
Sane.Status
usb_mid_n600_prepare_rgb (ma1017 * chip, Sane.Word dpi)
{
...
Sane.Status
usb_mid_n600_prepare_mono (ma1017 * chip, Sane.Word dpi)
{
...
static Sane.Word usb_mid_c600_optical_x_dpi[] =
...
usb_mid_c600_prepare_rgb_600_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_image_dpi (chip, Sane.FALSE, SW_P6P6))
  RIE (usb_low_set_soft_resample (chip, 1))
  RIE (usb_low_set_led_light_all (chip, Sane.FALSE))
...
usb_mid_c600_prepare_rgb_400_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_image_dpi (chip, Sane.FALSE, SW_P4P6))
  RIE (usb_low_set_soft_resample (chip, 1))
  RIE (usb_low_set_led_light_all (chip, Sane.FALSE))
...
usb_mid_c600_prepare_rgb_300_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_image_dpi (chip, Sane.FALSE, SW_P3P6))
  RIE (usb_low_set_soft_resample (chip, 1))
  RIE (usb_low_set_led_light_all (chip, Sane.FALSE))
...
usb_mid_c600_prepare_rgb_200_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_image_dpi (chip, Sane.FALSE, SW_P2P6))
  RIE (usb_low_set_soft_resample (chip, 1))
  RIE (usb_low_set_led_light_all (chip, Sane.FALSE))
...
usb_mid_c600_prepare_rgb_100_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_image_dpi (chip, Sane.FALSE, SW_P1P6))
  RIE (usb_low_set_soft_resample (chip, 1))
  RIE (usb_low_set_led_light_all (chip, Sane.FALSE))
...
Sane.Status
usb_mid_c600_prepare_rgb (ma1017 * chip, Sane.Word dpi)
{
...
Sane.Status
usb_mid_c600_prepare_mono (ma1017 * chip, Sane.Word dpi)
{
...
static Sane.Word usb_mid_c300600_optical_x_dpi[] =
  { 600, 400, 300, 200, 150, 100, 50, 0 ]
...
Sane.Status
usb_mid_c300600_prepare_rgb (ma1017 * chip, Sane.Word dpi)
{
...
static Sane.Word usb_mid_c300_optical_x_dpi[] = { 300, 200, 150, 100, 50, 0 ]
...
Sane.Status
usb_mid_c300_prepare_rgb (ma1017 * chip, Sane.Word dpi)
{
...
Sane.Status
usb_mid_c300_prepare_mono (ma1017 * chip, Sane.Word dpi)
{
...
Bool
usb_mid_sensor_is600_mode (ma1017 * chip, Sane.Word dpi)
{
...
static Sane.Status
usb_mid_sensor_prepare_rgb (ma1017 * chip, Sane.Word dpi)
{
  if (chip.sensor == ST_CANON300)
...
static Sane.Status
usb_mid_sensor_prepare_mono (ma1017 * chip, Sane.Word dpi)
{
  if (chip.sensor == ST_CANON300)
...
static Sane.Word usb_mid_motor1200_optical_dpi[] =
...
usb_mid_motor1200_prepare_rgb_1200_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_cmt_table (chip, 0, CH_GREEN, Sane.FALSE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 1, CH_BLUE, Sane.FALSE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 2, CH_RED, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 3, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 4, CH_GREEN, Sane.FALSE, Sane.FALSE))
  ...
  RIE (usb_low_set_motor_movement (chip, Sane.FALSE, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_io_3 (chip, Sane.FALSE))
...
usb_mid_motor1200_prepare_rgb_600_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_cmt_second_position (chip, 0))
  RIE (usb_low_set_cmt_loop_count (chip, 0xefff))
  RIE (usb_low_set_motor_movement (chip, Sane.TRUE, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_io_3 (chip, Sane.FALSE))
...
usb_mid_motor1200_prepare_rgb_400_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_cmt_table (chip, 0, CH_GREEN, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 1, CH_BLUE, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 2, CH_RED, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 3, CH_GREEN, Sane.FALSE, Sane.FALSE))
  ...
  RIE (usb_low_set_cmt_loop_count (chip, 0xefff))
  RIE (usb_low_set_motor_movement (chip, Sane.FALSE, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_io_3 (chip, Sane.TRUE))
...
usb_mid_motor1200_prepare_rgb_300_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_cmt_table (chip, 1, CH_BLUE, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 2, CH_RED, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 3, CH_GREEN, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 4, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table_length (chip, 4))
  RIE (usb_low_set_cmt_second_position (chip, 0))
  RIE (usb_low_set_cmt_loop_count (chip, 0xefff))
...
usb_mid_motor1200_prepare_rgb_100_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_cmt_second_position (chip, 0))
  RIE (usb_low_set_cmt_loop_count (chip, 0xefff))
  RIE (usb_low_set_motor_movement (chip, Sane.TRUE, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_io_3 (chip, Sane.TRUE))
...
usb_mid_motor1200_prepare_rgb_50_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_cmt_table (chip, 0, CH_GREEN, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 1, CH_GREEN, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 2, CH_BLUE, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 3, CH_BLUE, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 4, CH_RED, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 5, CH_RED, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 6, CH_GREEN, Sane.FALSE, Sane.FALSE))
...
usb_mid_motor1200_prepare_mono_1200_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_cmt_table (chip, 0, CH_GREEN, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 1, CH_GREEN, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 2, CH_GREEN, Sane.FALSE, Sane.FALSE))
...
usb_mid_motor1200_prepare_mono_600_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_cmt_table (chip, 0, CH_GREEN, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 1, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 2, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 3, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 4, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 5, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 6, CH_GREEN, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 7, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 8, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 9, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 10, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 11, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 12, CH_GREEN, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 13, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 14, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 15, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 16, CH_GREEN, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 17, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 18, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 19, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 20, CH_GREEN, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 21, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 22, CH_GREEN, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 23, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 24, CH_GREEN, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 25, CH_GREEN, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 26, CH_GREEN, Sane.FALSE, Sane.FALSE))
...
usb_mid_motor1200_prepare_mono_400_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_cmt_table (chip, 0, CH_GREEN, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 1, CH_GREEN, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 2, CH_GREEN, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 3, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table_length (chip, 3))
  RIE (usb_low_set_cmt_second_position (chip, 0))
  RIE (usb_low_set_cmt_loop_count (chip, 0xefff))
...
usb_mid_motor1200_prepare_mono_50_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_cmt_table (chip, 2, CH_GREEN, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 3, CH_GREEN, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 4, CH_GREEN, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 5, CH_GREEN, Sane.TRUE, Sane.FALSE))
  RIE (usb_low_set_cmt_table (chip, 6, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table_length (chip, 6))
  RIE (usb_low_set_cmt_second_position (chip, 0))
  RIE (usb_low_set_cmt_loop_count (chip, 0xefff))
...
usb_mid_motor1200_prepare_rgb_half_300_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_cmt_table (chip, 0, CH_GREEN, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 1, CH_GREEN, Sane.FALSE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 2, CH_BLUE, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 3, CH_BLUE, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 4, CH_RED, Sane.FALSE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 5, CH_RED, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 6, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table_length (chip, 6))
  RIE (usb_low_set_cmt_second_position (chip, 0))
  RIE (usb_low_set_cmt_loop_count (chip, 0xefff))
...
usb_mid_motor1200_prepare_rgb_bi_full_300_dpi (ma1017 * chip)
{
  ...
  RIE (usb_low_set_cmt_table (chip, 0, CH_GREEN, Sane.FALSE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 1, CH_GREEN, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 2, CH_BLUE, Sane.FALSE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 3, CH_BLUE, Sane.FALSE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 4, CH_RED, Sane.TRUE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 5, CH_RED, Sane.FALSE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 6, CH_GREEN, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table_length (chip, 6))
  RIE (usb_low_set_cmt_second_position (chip, 0))
  RIE (usb_low_set_cmt_loop_count (chip, 0xefff))
...
usb_mid_motor1200_prepare_rgb (ma1017 * chip, Sane.Word dpi)
{
  ...
  RIE (usb_low_move_motor_home (chip, Sane.FALSE, Sane.FALSE))
  /* No Motor & Forward */
  RIE (usb_low_set_motor_direction (chip, Sane.FALSE))
  RIE (usb_low_enable_motor (chip, Sane.TRUE))
  switch (dpi)
    {
    case 1200:
...
usb_mid_motor1200_prepare_step (ma1017 * chip, Sane.Word step_count)
{
  ...
  RIE (usb_low_set_motor_movement (chip, Sane.TRUE, Sane.TRUE, Sane.FALSE))
  /* Make it in 600dpi */
  RIE (usb_low_set_io_3 (chip, Sane.TRUE));	/* (IO3) ? High power : Low power */
  RIE (usb_low_move_motor_home (chip, Sane.FALSE, Sane.FALSE))
  /* No Motor & Forward */
  if (step_count == 1)
    {
      RIE (usb_low_set_cmt_table (chip, 0, CH_GREEN, Sane.TRUE, Sane.FALSE))
      RIE (usb_low_set_cmt_table (chip, 1, CH_GREEN, Sane.FALSE, Sane.FALSE))
...
usb_mid_motor1200_prepare_home (ma1017 * chip)
{
  ...
  if (chip.sensor == ST_NEC600)
    RIE (usb_low_set_motor_movement
	 (chip, Sane.FALSE, Sane.TRUE, Sane.FALSE))
  else
    RIE (usb_low_set_motor_movement (chip, Sane.TRUE, Sane.TRUE, Sane.FALSE))
  /* Make it in 600dpi */
  RIE (usb_low_set_io_3 (chip, Sane.TRUE));	/* (IO3) ? High power : Low power */
  RIE (usb_low_move_motor_home (chip, Sane.TRUE, Sane.TRUE))
...
usb_mid_motor1200_prepare_adjust (ma1017 * chip, Channel channel)
{
  ...
  RIE (usb_low_set_cmt_table (chip, 0, channel, Sane.FALSE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 1, channel, Sane.FALSE, Sane.TRUE))
  RIE (usb_low_set_cmt_table (chip, 2, channel, Sane.FALSE, Sane.FALSE))
  RIE (usb_low_set_cmt_table_length (chip, 2))
  RIE (usb_low_set_cmt_second_position (chip, 0))
  RIE (usb_low_set_cmt_loop_count (chip, 0xefff))
...
Sane.Word
usb_mid_motor1200_rgb_capability (Sane.Word dpi)
{
...
Sane.Word
usb_mid_motor1200_mono_capability (Sane.Word dpi)
{
...
static Sane.Word usb_mid_motor600_optical_dpi[] =
...
usb_mid_motor600_prepare_home (ma1017 * chip)
{
  ...
  RIE (usb_low_set_motor_movement (chip, Sane.FALSE, Sane.TRUE, Sane.TRUE))
  /* Make it in 600dpi */
  RIE (usb_low_set_io_3 (chip, Sane.TRUE));	/* (IO3) ? High power : Low power */
  RIE (usb_low_move_motor_home (chip, Sane.TRUE, Sane.TRUE))
...
Sane.Word
usb_mid_motor600_rgb_capability (Sane.Word dpi)
{
...
Sane.Word
usb_mid_motor600_mono_capability (Sane.Word dpi)
{
...
static Sane.Status
usb_mid_motor_prepare_rgb (ma1017 * chip, Sane.Word dpi)
{
  if (chip.motor == MT_600)
...
static Sane.Status
usb_mid_motor_prepare_mono (ma1017 * chip, Sane.Word dpi)
{
  if (chip.motor == MT_600)
...
static Sane.Word
usb_mid_motor_rgb_capability (ma1017 * chip, Sane.Word dpi)
{
  if (chip.motor == MT_600)
...
static Sane.Word
usb_mid_motor_mono_capability (ma1017 * chip, Sane.Word dpi)
{
  if (chip.motor == MT_600)
...
Sane.Status
usb_mid_front_enable (ma1017 * chip, Bool is_enable)
{
  Sane.Status status
...
usb_mid_front_set_top_reference (ma1017 * chip, Sane.Byte top)
{
  ...
  RIE (usb_mid_front_enable (chip, Sane.TRUE))
  RIE (usb_low_set_serial_byte1 (chip, 0x00))
  RIE (usb_low_set_serial_byte2 (chip, top))
  RIE (usb_mid_front_enable (chip, Sane.FALSE))
...
Sane.Status
usb_mid_front_set_red_pga (ma1017 * chip, Sane.Byte pga)
{
  Sane.Status status
...
Sane.Status
usb_mid_front_set_green_pga (ma1017 * chip, Sane.Byte pga)
{
  Sane.Status status
...
Sane.Status
usb_mid_front_set_blue_pga (ma1017 * chip, Sane.Byte pga)
{
  Sane.Status status
