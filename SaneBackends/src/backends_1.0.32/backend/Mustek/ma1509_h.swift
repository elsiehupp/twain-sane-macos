...
typedef struct Ma1509_Scanner
{
  ...
  Sane.Word total_bytes;	/* bytes read from scanner */
  Sane.Word read_bytes;		/* bytes transmitted by Sane.read */

  Int red_gamma_table[MA1509_GAMMA_SIZE]
  Int green_gamma_table[MA1509_GAMMA_SIZE]
  Int blue_gamma_table[MA1509_GAMMA_SIZE]

  Sane.Byte *buffer, *buffer_start
  Int buffer_bytes
