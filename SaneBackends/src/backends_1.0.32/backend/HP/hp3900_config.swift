...
static Int cfg_chipset_get(Int model, struct st_chip *chipset)

/* returns the chipset model for each scanner */
static Int cfg_chipset_model_get(Int device)

/* buttons for each scanner */
static Int cfg_buttons_get(struct st_buttons *reg)

/* area constraints for each scanner */
static Int cfg_constrains_get(struct st_constrains *constrain)

/* spectrum clock generator for each scanner */
static Int cfg_sscg_get(Int *enable, Int *mode, Int *clock)

/* motor general configuration for each scanner */
static Int cfg_motor_get(struct st_motorcfg *reg)

/* motor resource for each scanner */
static Sane.Byte *cfg_motor_resource_get(Sane.Byte *size)

/* sensor general configuration for each scanner */
static Int cfg_sensor_get(struct st_sensorcfg *reg)

/* reference voltages for each scanner */
static void cfg_refvoltages_get(Int sensortype, Sane.Byte *vrts, Sane.Byte *vrms, Sane.Byte *vrbs)
static void hp3800_refvoltages(Int usb, Int sensor, Sane.Byte *vrts, Sane.Byte *vrms, Sane.Byte *vrbs)
static void hp3970_refvoltages(Int usb, Int sensor, Sane.Byte *vrts, Sane.Byte *vrms, Sane.Byte *vrbs)

/* offset calibration start and length */
static void cfg_offset_get(Int sensortype, Int resolution, Int scantype, Int *left, Int *width)
static void ua4900_offset(Int resolution, Int scantype, Int *left, Int *width)
static void hp3800_offset(Int resolution, Int scantype, Int *left, Int *width)
static void hp3970_offset(Int sensor, Int resolution, Int scantype, Int *left, Int *width)
static void hp4370_offset(Int resolution, Int scantype, Int *left, Int *width)

/* autoref configuration */
static void cfg_autoref_get(struct st_autoref *reg)

/* autoref start effective pixel */
static Int cfg_effectivepixel_get(Int sensortype, Int resolution)
static Int ua4900_effectivepixel(Int resolution)
static Int hp3800_effectivepixel(Int resolution)
static Int hp3970_effectivepixel(Int sensor, Int resolution)
static Int hp4370_effectivepixel(Int resolution)

/* default values for gain and offset */
static Int cfg_gainoffset_get(Int sensortype, struct st_gain_offset *reg)
static Int bq5550_gainoffset(Int usb, struct st_gain_offset *myreg)
static Int ua4900_gainoffset(Int usb, struct st_gain_offset *myreg)
static Int hp3800_gainoffset(Int usb, struct st_gain_offset *myreg)
static Int hp3970_gainoffset(Int usb, Int sensor, struct st_gain_offset *myreg)
static Int hp4370_gainoffset(Int usb, struct st_gain_offset *myreg)

/* values to detect optimum pulse-width modulation */
static Int cfg_checkstable_get(Int lamp, struct st_checkstable *check)
static Int ua4900_checkstable(Int lamp, struct st_checkstable *check)
static Int hp3800_checkstable(Int lamp, struct st_checkstable *check)
static Int hp3970_checkstable(Int lamp, struct st_checkstable *check)
static Int hp4370_checkstable(Int lamp, struct st_checkstable *check)

/* fixed pulse-width modulation values */
static Int cfg_fixedpwm_get(Int sensortype, Int scantype)
static Int ua4900_fixedpwm(Int scantype, Int usb)
static Int hp3800_fixedpwm(Int scantype, Int usb)
...
static void hp4370_vrefs(Int res, Int *ser, Int *ler)

/* scanmodes supported by each scanner */
static Int cfg_scanmode_get(Int sensortype, Int sm, struct st_scanmode *mymode)
static Int bq5550_scanmodes(Int usb, Int sm, struct st_scanmode *mymode)
static Int ua4900_scanmodes(Int usb, Int sm, struct st_scanmode *mymode)
static Int hp3800_scanmodes(Int usb, Int sm, struct st_scanmode *mymode)
static Int hp3970_scanmodes(Int usb, Int ccd, Int sm, struct st_scanmode *mymode)
static Int hp4370_scanmodes(Int usb, Int sm, struct st_scanmode *mymode)

/* timing values for ccd sensors */
static Int cfg_timing_get(Int sensortype, Int tm, struct st_timing *reg)
static Int bq5550_timing_get(Int tm, struct st_timing *reg)
static Int ua4900_timing_get(Int tm, struct st_timing *reg)
static Int hp3800_timing_get(Int tm, struct st_timing *reg)
static Int hp3970_timing_get(Int sensortype, Int tm, struct st_timing *reg)
static Int hp4370_timing_get(Int tm, struct st_timing *reg)

/* motor movements */
static Int cfg_motormove_get(Int sensortype, Int mm, struct st_motormove *reg)
static Int bq5550_motormove(Int item, struct st_motormove *reg)
static Int hp3800_motormove(Int item, struct st_motormove *reg)
static Int hp3970_motormove(Int usb, Int ccd, Int item, struct st_motormove *reg)

/* motor curves */
static Int *cfg_motorcurve_get(void)
static Int *bq5550_motor(void)
static Int *hp3800_motor(void)
static Int *hp3970_motor(void)
static Int *hp4370_motor(void)

/* shading cut values */
static void cfg_shading_cut_get(Int sensortype, Int depth, Int res, Int scantype, Int *red, Int *green, Int *blue)
static void ua4900_shading_cut(Int usb, Int depth, Int res, Int scantype, Int *red, Int *green, Int *blue)
static void hp3800_shading_cut(Int res, Int scantype, Int *red, Int *green, Int *blue)
static void hp3970_shading_cut(Int usb, Int ccd, Int depth, Int res, Int scantype, Int *red, Int *green, Int *blue)
static void hp4370_shading_cut(Int depth, Int res, Int scantype, Int *red, Int *green, Int *blue)

/* wrefs values */
static void cfg_wrefs_get(Int sensortype, Int depth, Int res, Int scantype, Int *red, Int *green, Int *blue)
static void ua4900_wrefs(Int usb, Int depth, Int res, Int scantype, Int *red, Int *green, Int *blue)
static void hp3800_wrefs(Int res, Int scantype, Int *red, Int *green, Int *blue)
static void hp3970_wrefs(Int usb, Int ccd, Int depth, Int res, Int scantype, Int *red, Int *green, Int *blue)
static void hp4370_wrefs(Int res, Int scantype, Int *red, Int *green, Int *blue)
...
static Int cfg_motormove_get(Int sensortype, Int item, struct st_motormove *reg)
{
	Int rst = ERROR
...
static void hp3800_shading_cut(Int res, Int scantype, Int *red, Int *green, Int *blue)
{
	...
	Int a
	Int count = sizeof(cuts) / sizeof(struct st_cut)
