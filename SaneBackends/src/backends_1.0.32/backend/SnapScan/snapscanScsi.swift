...
static Sane.Status snapscan_cmd(SnapScan_Bus bus, Int fd, const void *src,
...
/* TODO: Remove */
static char *snapscani_debug_data(char *str,const Sane.Byte *data, Int len) {
    char tmpstr[10]
    var i: Int
...
static Sane.Status set_window(SnapScan_Scanner *pss)
{
    ...
    {
        Int tlxp =
            (Int) (pos_factor*IN_PER_MM*Sane.UNFIX(pss.tlx))
        Int tlyp =
            (Int) (pos_factor*IN_PER_MM*Sane.UNFIX(pss.tly))
        Int brxp =
            (Int) (pos_factor*IN_PER_MM*Sane.UNFIX(pss.brx))
        Int bryp =
 ...
 * Get name of firmware file in Sane.init
 *
