...
static Int snapscani_mutex_open(snapscan_mutex_t* a_sem, const char* dev __Sane.unused__)
{
...
static Int snapscani_mutex_open(snapscan_mutex_t* sem_id, const char* dev __Sane.unused__)
{
...
/* union semun is defined by including <sys/sem */
#else
