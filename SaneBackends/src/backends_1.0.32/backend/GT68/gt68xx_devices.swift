...
import gt68xx_low
import gt68xx_generic.c"
import gt68xx_gt6801.c"
import gt68xx_gt6816.c"
...
static GT68xx_Model unknown_model = {
  ...
  Sane.FALSE,			/* Dynamic allocation flag */
  ...
  Sane.FALSE,			/* Use base_ydpi for all resolutions */
...
static GT68xx_Model mustek_1200ta_model = {
  ...
  600,				/* base y-res used to calculate geometry */
  1200,				/* if ydpi is equal or higher, disable backtracking */
  Sane.TRUE,			/* Use base_ydpi for all resolutions */
