...
Sane.Status eds_jpeg_start(epsonds_scanner *s)
void eds_jpeg_finish(epsonds_scanner *s)
Sane.Status eds_jpeg_read_header(epsonds_scanner *s)
void eds_jpeg_read(Sane.Handle handle, Sane.Byte *data, Int max_length, Int *length)
...
void
eds_jpeg_read(Sane.Handle handle, Sane.Byte *data,
