...
static Bool Transparent_SetupScan(COLORMODE ColorMode, unsigned short XDpi, unsigned short YDpi,
				   Bool isInvert, unsigned short X, unsigned short Y, unsigned short Width,
				   unsigned short Height)
static Bool Transparent_StopScan(void)
static Bool Transparent_GetRows(Sane.Byte * lpBlock, unsigned short * Rows, Bool isOrderInvert)
static Bool Transparent_AdjustAD(void)
static Bool Transparent_FindTopLeft(unsigned short * lpwStartX, unsigned short * lpwStartY)
static Bool Transparent_LineCalibration16Bits(unsigned short wTAShadingMinus)
...
***********************************************************************/
static Bool
Transparent_GetRows(Sane.Byte * lpBlock, unsigned short * Rows, Bool isOrderInvert)
{
...
Transparent_AdjustAD()
{
  ...
  float fGFactor = 1.0
  float fBFactor = 1.0
  Sane.Byte bDarkMaxLevel
  Sane.Byte bDarkMinLevel
  Sane.Byte bLastMinR, bLastROffset, bROffsetUpperBound = 255, bROffsetLowerBound =
    0
  Sane.Byte bLastMinG, bLastGOffset, bGOffsetUpperBound = 255, bGOffsetLowerBound =
    0
  Sane.Byte bLastMinB, bLastBOffset, bBOffsetUpperBound = 255, bBOffsetLowerBound =
    0
#endif
  ...
  g_chip.AD.GainG =
    ...
    0 ? (Sane.Byte) (((1 - (double) (wMaxValueG - wMinValueG) / 210)) * 63 * 6 /
		5) : 0
  g_chip.AD.GainB =
