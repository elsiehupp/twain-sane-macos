...
import dev/ppbus/ppi
import dev/ppbus/ppbconf
#endif

#ifdef HAVE_MACHINE_CPUFUNC_H
import machine/cpufunc
#endif

#ifdef HAVE_I386_SET_IOPERM
import machine/sysarch
#endif
...
/* Sane.INB is defined whenever a valid inb/outb */
...
probe610p(Int recover)
{
   ...
   */
func Int probePS2 (unsigned char *dest)
{
  var i: Int, tmp
