 ...
 *
 */
func Int sanei_umax_pp_model(Int port, Int *model)
{
  Int recover = 0, rc
...
func Int sanei_umax_pp_attach(Int port, const char *name)
{
  Int recover = 0
...
func Int sanei_umax_pp_open(Int port, char *name)
{
  Int rc
  Int recover = 0
...
func Int sanei_umax_pp_cancel(void)
{
...
func Int sanei_umax_pp_start(Int x, Int y, Int width, Int height, Int dpi, Int color,
                     Int autoset,
...
func Int sanei_umax_pp_read(long len, Int window, Int dpi, Int last,
...
func Int sanei_umax_pp_lamp(Int on)
{
  /* init transport layer */
