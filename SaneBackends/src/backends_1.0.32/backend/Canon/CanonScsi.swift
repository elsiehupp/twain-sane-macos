...
static Sane.Status
get_density_curve_fs2710 (Sane.Handle handle, Int component, u_char *buf,
			  size_t *buf_size)
{
...
static Sane.Status
set_density_curve_fs2710 (Sane.Handle handle, Int component, u_char *buf)
{
  CANON_Scanner *s = handle
  var i: Int, j, hi, lo
  u_char *p
...
static Sane.Status
set_parameters_fs2710 (Sane.Handle handle)
{
  CANON_Scanner *s = handle
  var i: Int, j, shadow[4], hilite[4]
  double x, b, c
