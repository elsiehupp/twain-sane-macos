...
#define _LOBYTE(x)  ((Sane.Byte)((x) & 0xFF))
#define _HIBYTE(x)  ((Sane.Byte)((x) >> 8))
 ...
 */
typedef struct {
	Sane.Byte RD_Motor1Control;     /* 0x0b           */
	Sane.Byte RD_StepControl;       /* 0x14           */
	Sane.Byte RD_Motor0Control;     /* 0x15           */
	Sane.Byte RD_XStepTime;         /* 0x16           */
	Sane.Byte RD_ModeControl;       /* 0x1b           */
	Sane.Byte RD_LineControl;       /* 0x1c           */
	Sane.Byte RD_ScanControl;       /* 0x1d, init = 5 */
	Sane.Byte RD_ModelControl;      /* 0x1f           */
	Sane.Byte RD_Model1Control;     /* 0x20           */
	u_short   RD_Dpi;               /* 0x21           */
	u_short   RD_Origin;            /* 0x23           */
	u_short   RD_Pixels;            /* 0x25           */
	u_short   RD_ThresholdControl;  /* 0x27           */
	Sane.Byte RD_ThresholdGapCtrl;  /* 0x29           */
	...
	Sane.Byte RD_ScanControl1;      /* 0x5b   */
	Sane.Byte RD_MotorDriverType;   /* 0x64   */
	Sane.Byte RD_ExtLineControl;    /* 0x6d   */
	Sane.Byte RD_ExtXStepTime;      /* 0x6e   */
...
typedef struct
{
	...
	u_short        wDarkLevels
	Sane.Byte      intermediate

	u_long         dwDiv
	Sane.Byte      skipShadow

	Sane.Byte      skipHilight
	ColorByte      Hilight
	RGBUShortDef  *pHilight
	ColorByte      Gain
	Sane.Byte      bGainDouble
	Sane.Byte      bUniGain
	Sane.Byte      bMinGain
	Sane.Byte      bMaxGain
	Sane.Byte      bGainHigh
