...
/*{ var i: Int; for( i = msecs; i--; ) _DO_UDELAY(1000); }*/
#else
...
typedef struct
{
	...
	Bool       refreshState
	Bool       motorBackward
	Sane.Byte       oldScanState
	Sane.Byte       bRefresh
	Sane.Byte       bModuleState
	Sane.Byte       bNowScanState

	/* internal FIFO management */
	u_long          dwMinReadFifo
	u_long          dwMaxReadFifo
	Sane.Byte       bFifoSelect;    /* defines which FIFO to use            */
