 ...
 */
static Sane.Status u12map_InitGammaSettings( U12_Device *dev )
{
	Int    i, j, val
	double gamma
 ...
 */
static void u12map_Adjust( U12_Device *dev, Int which, Sane.Byte *buf )
{
	Int     i
	u_long *pdw
	double  b, c, tmp
	...
	DBG( _DBG_INFO, "* brightness   = %i -> %i\n",
	                 dev.DataInf.siBrightness, (Sane.Byte)b)
