...
import linux/types /* used later in this header */
...
#  define cpu_to_be32p(addr) (cpu_to_be32(*(addr)))
   ...
   public inline void cpu_to_le16s(__u16 *a) {*a = cpu_to_le16(*a);}
   public inline void cpu_to_le32s(__u16 *a) {*a = cpu_to_le32(*a);}
   public inline void cpu_to_be16s(__u16 *a) {*a = cpu_to_be16(*a);}
   public inline void cpu_to_be32s(__u16 *a) {*a = cpu_to_be32(*a);}
