...
import plustek-pp_sysdep
import linux/delay
import linux/parport

#ifdef LINUX_24
import linux/parport_pc
#endif	/* LINUX_24   */
...
# define _DODELAY(msecs)     { var i: Int; for( i = msecs; i--; ) _DO_UDELAY(1000); }
#else
 ...
 */
import plustek-pp_types
import plustek-pp_hwdefs
import plustek-pp_scandata
import plustek-pp_procs
import plustek-pp_dbg
