...
/**
 */
static Bool fnReadToDriver( U12_Device *dev )
{
...
/**
 */
static Bool fnReadOutScanner( U12_Device *dev )
{
 ...
 */
static Bool fnEveryLine( U12_Device *dev )
{
	_VAR_NOT_USED( dev )
	return Sane.TRUE
}

static Bool fnSampleLines( U12_Device *dev )
{
...
static Bool fnSamplePreview( U12_Device *dev )
{
 ...
 */
static u_short
u12image_GetPhysDPI( U12_Device *dev, ImgDef *img, Bool fDpiX )
{
	if( fDpiX ) {
...
static void u12image_GetImageInfo( U12_Device *dev, ImgDef *image )
{
	...
	dev.DataInf.xyPhyDpi.x = u12image_GetPhysDPI(dev, image, Sane.TRUE )
	dev.DataInf.xyPhyDpi.y = u12image_GetPhysDPI(dev, image, Sane.FALSE)
 ...
 */
static Sane.Status u12image_SetupScanSettings( U12_Device *dev, ImgDef *img )
{
...
/**
 */
static Bool u12image_DataIsReady( U12_Device *dev, void* buf )
{
...
/**
 */
static Sane.Status u12image_ReadOneImageLine( U12_Device *dev, void* buf )
{
	Sane.Byte  b, state
	TimerDef  timer, t2
 ...
 */
static void u12image_ScaleX( U12_Device *dev, Sane.Byte *ib, Sane.Byte *ob )
{
	Sane.Byte tmp
	Int       ddax
	u_long    i, j, x
