 ...
 */
static Int
cano_PrepareToReadWhiteCal( Plustek_Device *dev, Bool mv2shading_pos )
{
...
cano_AdjustOffset( Plustek_Device *dev )
{
	...
	for( i = 0, adj = 1; adj != 0; i++ ) {
		...
		_UIO(sanei_lm983x_write(dev.fd, 0x38, &dev.usbDev.a_bRegs[0x38], 3, Sane.TRUE))
	}
