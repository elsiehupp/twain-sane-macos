 ...
 */
static Bool u12io_IsEscPressed( void )
{
	sigset_t sigs
 ...
 * @return Function returns  Sane.TRUE when the timer has been expired,
 *         otherwise Sane.FALSE
 */
static Bool u12io_CheckTimer( TimerDef *timer )
{
...
static Sane.Byte bulk_setup_data[] = { 0, 0x11, 0, 0, 0, 0, 0, 0 ]
 ...
 */
static void u12io_RegisterToScanner( U12_Device *dev, Sane.Byte reg )
{
 ...
 */
static Sane.Byte u12io_DataFromSPP( U12_Device *dev )
{
	Sane.Byte data, tmp
 ...
 */
static Sane.Byte u12io_DataFromRegister( U12_Device *dev, Sane.Byte reg )
{
	Sane.Byte val
 ...
 */
static Bool u12io_OpenScanPath( U12_Device *dev )
{
	u_char tmp
 ...
 */
static Sane.Status u12io_DataToRegs( U12_Device *dev, Sane.Byte *buf, Int len )
{
	Sane.Status status
 ...
 */
static void
u12io_DataRegisterToDAC( U12_Device *dev, Sane.Byte reg, Sane.Byte val )
{
	Sane.Byte buf[6]
 ...
 */
static Sane.Status u12io_MoveDataToScanner( U12_Device *dev,
                                            Sane.Byte *buf, Int len )
{
	Sane.Status status
...
static Sane.Status u12io_ReadData( U12_Device *dev, Sane.Byte *buf, Int len )
{
	Sane.Status status
...
/**
 */
static Bool u12io_IsConnected( U12_Device *dev )
{
	Int       c, mode
	Sane.Byte tmp, rb[6]
...
/**
 */
static Sane.Byte u12io_GetExtendedStatus( U12_Device *dev )
{
	Sane.Byte b
...
/**
 */
static Sane.Status u12io_ReadMonoData( U12_Device *dev, Sane.Byte *buf, u_long len )
{
	Sane.Status status
 ...
 */
static Sane.Status
u12io_ReadColorData( U12_Device *dev, Sane.Byte *buf, u_long len )
{
	Sane.Status status
 ...
 */
static Sane.Byte u12io_GetScanState( U12_Device *dev )
{
	if( cacheLen[0] == 0x83 ) {
 ...
 */
static Sane.Status u12io_DownloadScanStates( U12_Device *dev )
{
	Sane.Status status
	TimerDef    timer
 ...
 */
static Bool
u12io_ReadOneShadingLine( U12_Device *dev, Sane.Byte *buf, u_long len )
{
	TimerDef    timer
	Sane.Status status
