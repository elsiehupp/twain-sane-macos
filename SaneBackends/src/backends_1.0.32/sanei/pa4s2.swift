...
/* debug levels:
   ...
   Sane.DEBUG_SANEI_PA4S2 */

import Sane.config

#define BACKEND_NAME sanei_pa4s2
import Sane.sanei_backend	/* pick up compatibility defs */
...
#define TEST_DBG_INIT() if(sanei_pa4s2_dbg_init_called == Sane.FALSE) \
                          {                                            \
                            ...
                            DBG(6, "sanei_pa4s2: interface called for" \
                              " the first time\n");                    \
                            sanei_pa4s2_dbg_init_called = Sane.TRUE;   \
                          }
#else
...
static PortRec port[] =
{
  {"0x378", 0x378, Sane.FALSE, Sane.FALSE, PA4S2_MODE_NIB,
    {0, 0, 0}},
  {"0x278", 0x278, Sane.FALSE, Sane.FALSE, PA4S2_MODE_NIB,
    {0, 0, 0}},
  {"0x3BC", 0x3BC, Sane.FALSE, Sane.FALSE, PA4S2_MODE_NIB,
    {0, 0, 0}}
]
