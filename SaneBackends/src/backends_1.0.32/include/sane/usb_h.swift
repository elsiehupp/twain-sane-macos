...
struct sanei_usb_dev_descriptor
{
	...
	Sane.Byte    dev_class
	Sane.Byte    dev_sub_class
	Sane.Byte    dev_protocol
	Sane.Byte    max_packet_size
]
 ...
 */
public Sane.Status sanei_usb_testing_enable_replay(Sane.String_Const path,
 ...
 */
public Sane.Status sanei_usb_testing_enable_record(Sane.String_Const path,
                                                   Sane.String_Const be_name)
 ...
 */
public String sanei_usb_testing_get_backend()

/** Returns Sane.TRUE if replay testing mode is enabled, i.e. whether we are working with fake
 * scan data.
 */
public Bool sanei_usb_is_replay_mode_enabled()
 ...
 * - Sane.STATUS_INVAL - if the device is not found
 * - Sane.STATUS_UNSUPPORTED - if this method is not supported with the current
 *   access method
 */
Sane.Status
 ...
 * @return
 * - Sane.STATUS_GOOD - on success
 * - Sane.STATUS_IO_ERROR - on error
 * - Sane.STATUS_UNSUPPORTED - if the feature is not supported by the OS or
 *   SANE.
 */
public Sane.Status
