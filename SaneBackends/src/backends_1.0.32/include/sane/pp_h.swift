 ...
 */
public Sane.Status sanei_pp_init( void )
 ...
 * @return
 */
public Sane.Status sanei_pp_open( const char *dev, Int *fd )
 ...
 * @return
 */
public Sane.Status sanei_pp_claim( Int fd )
 ...
 * @return
 */
public Sane.Status sanei_pp_release( Int fd )
 ...
 */
public Sane.Status sanei_pp_set_datadir( Int fd, Int rev )
 ...
 *
 * @return Sane.TRUE if we use direct access, Sane.FALSE if the lib uses
 *         libieee1284 functions.
 */
public Bool sanei_pp_uses_directio( void )
 ...
 * @return Sane.STATUS_GOOD on success.
 */
public Sane.Status sanei_pp_getmodes( Int fd, Int *mode )
