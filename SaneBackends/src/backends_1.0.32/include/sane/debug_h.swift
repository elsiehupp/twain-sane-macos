...
/** @def ENTRY(name)
 * Expands to Sane.BACKEND_NAME_name.
 *
 * Example: ENTRY(init) in mustek.c will expand to Sane.mustek_init.
 */
...
/* @} */
                                  ...
                                  /** @hideinitializer*/
#define ENTRY(name)     PASTE(PASTE(PASTE(Sane.,BACKEND_NAME),_),name)
