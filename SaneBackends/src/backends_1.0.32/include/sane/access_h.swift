 ...
 */
public void sanei_access_init( const char * backend )
 ...
 * $PATH_Sane.LOCK_DIR/LCK..&lt;devicename&gt
 ...
 * @return
 * - Sane.STATUS_GOOD          - if the lock has been successfully set
 * - Sane.STATUS_ACCESS_DENIED - the lock could not set
 */
public Sane.Status sanei_access_lock( const char * devicename, Sane.Word timeout )
 ...
 * @return
 * - Sane.STATUS_GOOD - currently the one and only return value
 */
public Sane.Status sanei_access_unlock( const char * devicename )
