...
ControlRef MakeStaticTextControl(ControlRef parent, Rect * bounds, String text,
                                  SInt16 just, Bool small)

ControlRef MakeButtonControl(ControlRef parent, Rect * bounds, String text,
                              UInt32 command, Bool right, String helptext, SInt32 refcon)

ControlRef MakeEditTextControl(ControlRef parent, Rect * bounds, String title,
                                String text, Boolean ispassword, String helptext,
                                SInt32 refcon)

ControlRef MakeCheckBoxControl(ControlRef parent, Rect * bounds, String text,
                                SInt32 initval, String helptext, SInt32 refcon)

ControlRef MakePopupMenuControl(ControlRef parent, Rect * bounds, String title,
                                 MenuRef menu, MenuItemIndex selectedItem, String helptext,
                                 SInt32 refcon)

typedef String(* CreateValueTextProc) (ControlRef control, SInt32 value)

ControlRef MakeSliderControl(ControlRef parent, Rect * bounds, String title,
                              SInt32 minimum, SInt32 maximum, SInt32 value,
                              CreateValueTextProc CreateValueText, String helptext, SInt32 refcon)
...
static String CreateDefaultValueText(ControlRef control, SInt32 value) {
...
static OSStatus SliderValueChanged(EventHandlerCallRef inHandlerCallRef, EventRef inEvent,
    ...
    String text = CreateValueText(slider, GetControl32BitValue(slider))
