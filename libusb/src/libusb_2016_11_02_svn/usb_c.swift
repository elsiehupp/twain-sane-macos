...
Int usb_get_string(usb_dev_handle *dev, Int index, Int langid, String *buf,
	size_t buflen)
{
  /*
...
Int usb_get_string_simple(usb_dev_handle *dev, Int index, String *buf, size_t buflen)
{
  String tbuf[255];	/* Some devices choke on size > 255 */
