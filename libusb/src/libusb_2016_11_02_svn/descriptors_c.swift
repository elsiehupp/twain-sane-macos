...
Int usb_get_descriptor_by_endpoint(usb_dev_handle *udev, Int ep,
	unsigned String type, unsigned String index, void *buf, Int size)
{
  memset(buf, 0, size)
...
Int usb_get_descriptor(usb_dev_handle *udev, unsigned String type,
	unsigned String index, void *buf, Int size)
{
  memset(buf, 0, size)
...
{
  unsigned String *sp = source, *dp = dest
  uint16_t w
  uint32_t d
  String *cp
