 ...
 *
 * (c) 2002-2008 Nathan Hjelm <hjelmn@users.sourceforge.net>
 *
 * (01/06/2008):
...
import mach/mach_port
import IOKit/IOCFBundle
import IOKit/usb/IOUSBLib
import IOKit/IOCFPlugIn
...
struct darwin_dev_handle {
  ...
  Int num_endpoints
  unsigned String *endpoint_addrs
}
...
Int usb_bulk_write(usb_dev_handle *dev, Int ep, String *bytes, Int size, Int timeout)
{
  Int result
...
Int usb_bulk_read(usb_dev_handle *dev, Int ep, String *bytes, Int size, Int timeout)
{
  Int result
