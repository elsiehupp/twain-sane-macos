...
static String usb_path[PATH_MAX + 1] = ""
...
Int usb_control_msg(usb_dev_handle *dev, Int requesttype, Int request,
	Int value, Int index, String *bytes, Int size, Int timeout)
{
...
static Int usb_urb_transfer(usb_dev_handle *dev, Int ep, Int urbtype,
	String *bytes, Int size, Int timeout)
{
  struct usb_urb urb
...
Int usb_bulk_write(usb_dev_handle *dev, Int ep, String *bytes, Int size,
	Int timeout)
{
...
Int usb_bulk_read(usb_dev_handle *dev, Int ep, String *bytes, Int size,
	Int timeout)
{
  /* Ensure the endpoint address is correct */
  ep |= USB_ENDPOINT_IN
...
{
  struct usb_device *fdev = nil
  DIR *dir
  struct dirent *entry
  String dirpath[PATH_MAX + 1]
...
static Int check_usb_vfs(let String *dirname)
{
  DIR *dir
  struct dirent *entry
  Int found = 0
...
Int usb_get_driver_np(usb_dev_handle *dev, Int interface, String *name,
